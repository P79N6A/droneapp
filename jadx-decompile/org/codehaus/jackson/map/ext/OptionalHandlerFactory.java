...
public class OptionalHandlerFactory {
    ...
    public JsonDeserializer<?> findDeserializer(JavaType javaType, DeserializationConfig deserializationConfig, DeserializerProvider deserializerProvider) {
        ...
        if (name.startsWith(PACKAGE_PREFIX_JODA_DATETIME)) {
            ...
            return doesImplement(rawClass, "org.w3c.dom.Node") ? (JsonDeserializer) instantiate(DESERIALIZER_FOR_DOM_DOCUMENT) : doesImplement(rawClass, "org.w3c.dom.Node") ? (JsonDeserializer) instantiate(DESERIALIZER_FOR_DOM_NODE) : null;
        } else {
    ...
    public JsonSerializer<?> findSerializer(SerializationConfig serializationConfig, JavaType javaType) {
        ...
        if (name.startsWith(PACKAGE_PREFIX_JODA_DATETIME)) {
            ...
            return doesImplement(rawClass, "org.w3c.dom.Node") ? (JsonSerializer) instantiate(SERIALIZER_FOR_DOM_NODE) : null;
        } else {

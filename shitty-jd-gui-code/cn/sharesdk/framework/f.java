  ...
  extends SSDKHandlerThread
{
  ...
  private boolean a(a parama, HashMap<String, Object> paramHashMap1, HashMap<String, Object> paramHashMap2)
  {
    try
    {
      ...
      {
        d.a().i("ShareSDK parse sns config ==>>", new Object[] { new Hashon().fromHashMap(paramHashMap1) });
        return false;
      }
      ...
      paramHashMap2.putAll(parama.b(paramHashMap1));
      return true;
    }
    ...
    new Thread()
    {
      public void run()
      {
        try
        {
          ...
          if ((!f.this.d()) && (f.this.a(localHashMap))) {
            f.this.b(localHashMap);
          }
          return;
        }
  ...
  private void j()
  {
    e locale = new e(this.b, this.j);
    locale.a(this);
    locale.a(this.handler, this.k, 68);
  }
  ...
  public String a(int paramInt, String paramString)
  {
    synchronized (this.h)
    {
      paramString = new e(this.b, this.j).a(paramInt, paramString, this.h);
      return paramString;
    }
  }
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    return new e(this.b, this.j).a(paramBitmap);
  }
  ...
  public String a(String paramString1, boolean paramBoolean, int paramInt, String paramString2)
  {
    ...
    return new e(this.b, this.j).a(paramString1, paramBoolean, paramInt, paramString2);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    synchronized (this.h)
    {
      new e(this.b, this.j).a(paramInt1, paramInt2, this.h);
      return;
    }
  }
  ...
  {
    new e(this.b, this.j).a(paramInt, paramPlatform);
  }
  ...
  {
    new e(this.b, this.j).a(paramString, paramInt);
  }
  ...
  public boolean a(HashMap<String, Object> paramHashMap)
  {
    ...
    final a locala = a.a(this.b, this.j);
    boolean bool2 = a(locala, locala.d(), paramHashMap);
    if (bool2)
    {
      this.n = true;
      new Thread()
      {
        public void run()
        {
          try
          {
            HashMap localHashMap1 = locala.e();
            HashMap localHashMap2 = new HashMap();
            if (f.a(f.this, locala, localHashMap1, localHashMap2)) {
              f.this.b(localHashMap2);
            }
  ...
  public String b()
  {
    try
    {
      String str = new e(this.b, this.j).c();
      return str;
    }
    catch (Throwable localThrowable)
    {
  ...
  public boolean b(HashMap<String, Object> paramHashMap)
  {
    ...
    {
      this.h.clear();
      boolean bool = new e(this.b, this.j).a(paramHashMap, this.h);
      return bool;
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    return new e(this.b, this.j).a(paramString);
  }
  ...
  protected void onStart(Message arg1)
  {
    synchronized (this.i)
    {
      synchronized (this.d)
      {
        try
        {
          String str = EventRecorder.checkRecord("ShareSDK");
          if (!TextUtils.isEmpty(str))
          {
            a.a(this.b, this.j).a(null);
            d.a().w("EventRecorder checkRecord result ==" + str, new Object[0]);
            e();
          }
          EventRecorder.clear();
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/framework/f.class

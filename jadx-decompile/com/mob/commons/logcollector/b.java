...
public class b {
    ...
    public int a(String str, String str2, String[] strArr) {
        ...
        try {
            ...
            try {
                MobLog.getInstance().d("Deleted %d rows from table: %s", new Object[]{Integer.valueOf(delete), str});
            } catch (Exception e2) {
                e = e2;
                MobLog.getInstance().w(e, "when delete database occur error table:%s,", new Object[]{str});
                return delete;
            }
        } catch (Throwable e3) {
            e = e3;

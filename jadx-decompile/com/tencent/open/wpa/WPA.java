...
public class WPA extends BaseApi {
    ...
    public void getWPAUserOnlineState(String str, IUiListener iUiListener) {
        if (str == null) {
            ...
            Bundle bundle = null;
            HttpUtils.requestAsync(this.mToken, Global.getContext(), "http://webpresence.qq.com/getonline?Type=1&" + str + ":", bundle, "GET", new BaseApi$TempRequestListener(this, iUiListener));
    ...
    public int startWPAConversation(Activity activity, String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "1");
            return -1;
        } else if (str.length() < 5) {
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "1");
            return -3;
            ...
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "0");
            return i;
        }
    }
}

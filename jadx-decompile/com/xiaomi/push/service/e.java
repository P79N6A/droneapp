...
public class e {
    ...
    public synchronized long a(j jVar) {
        ...
        try {
            ...
            contentValues.put(User.FN_NAME, jVar.c());
            contentValues.put(com.xiaomi.market.sdk.l.PACKAGE_NAME, jVar.g());
            ...
            if (a != null) {
                while (a.moveToNext()) {
                    try {
                        ...
                        jVar.b(a.getString(a.getColumnIndex(User.FN_NAME)));
                        jVar.a((long) a.getInt(a.getColumnIndex("appId")));
                        jVar.c(a.getString(a.getColumnIndex(com.xiaomi.market.sdk.l.PACKAGE_NAME)));

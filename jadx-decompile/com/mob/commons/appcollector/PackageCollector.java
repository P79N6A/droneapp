...
public class PackageCollector {
    ...
    private void b() {
        ...
        if (c == null || c.isEmpty()) {
            try {
                ...
                c = (ArrayList) ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.c}), "getInstalledApp", objArr);
            } catch (Throwable th) {
        ...
        if (a >= d()) {
            try {
                ...
                c = (ArrayList) ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.c}), "getInstalledApp", objArr2);
            } catch (Throwable th2) {
        ...
        this.c.registerReceiver(new BroadcastReceiver(this) {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (this.a.a(str) && this.a.e != null) {
                    ...
                    this.a.e.sendEmptyMessageDelayed(1, 5000);
                }
            }
        }, intentFilter);
    }
    ...
    private void f() {
        ...
        try {
            Object[] objArr = new Object[]{Boolean.valueOf(false)};
            arrayList = (ArrayList) ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.c}), "getInstalledApp", objArr);
        } catch (Throwable th) {
            MobLog.getInstance().w(th);

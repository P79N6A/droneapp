...
public class a
{
  ...
  private void a(ViewGroup paramViewGroup, AdSizeParcel paramAdSizeParcel, String paramString, int paramInt1, int paramInt2)
  {
    ...
    paramString.addView(localTextView, new FrameLayout.LayoutParams(paramAdSizeParcel.g - paramInt1, paramAdSizeParcel.d - paramInt1, 17));
    paramViewGroup.addView(paramString, paramAdSizeParcel.g, paramAdSizeParcel.d);
  }
  ...
  {
    a(paramContext, paramString1, paramString2, paramBundle, paramBoolean, new a()
    {
  ...
  public void a(Context paramContext, @Nullable String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean, a parama)
  {
    if (paramBoolean)
    {
      ...
      {
        int i = j.b().c(paramContext);
        localObject = 23 + i + "." + 9683000;
      }
  ...
  public void a(boolean paramBoolean, HttpURLConnection paramHttpURLConnection, @Nullable String paramString)
  {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/google/android/gms/ads/internal/util/client/a.class

...
public class FimiMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getCodecLongNameInline() {
            return !TextUtils.isEmpty(this.mCodecLongName) ? this.mCodecLongName : !TextUtils.isEmpty(this.mCodecName) ? this.mCodecName : b.ar;
        }

        public String getFpsInline() {
            return (this.mFpsNum <= 0 || this.mFpsDen <= 0) ? b.ar : String.valueOf(((float) this.mFpsNum) / ((float) this.mFpsDen));
        }

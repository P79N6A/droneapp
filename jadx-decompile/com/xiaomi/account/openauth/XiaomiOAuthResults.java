...
public class XiaomiOAuthResults {
    ...
    public static XiaomiOAuthResults parseBundle(Bundle bundle) {
        return bundle == null ? null : getIntCompatibly(bundle, "extra_error_code", "error") != 0 ? new XiaomiOAuthResults(bundle, Error.parseBundle(bundle)) : new XiaomiOAuthResults(bundle, Success.parseBundle(bundle));
    }

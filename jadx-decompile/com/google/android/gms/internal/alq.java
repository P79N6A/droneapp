...
public interface alq extends IInterface {
    ...
    public static abstract class a extends Binder implements alq {

        private static class a implements alq {
            private IBinder a;
        ...
        public static alq a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IStatusCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alq)) ? new a(iBinder) : (alq) queryLocalInterface;
        }

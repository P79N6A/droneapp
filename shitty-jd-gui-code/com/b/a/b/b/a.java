  ...
  implements b
{
  ...
  protected Bitmap a(Bitmap paramBitmap, c paramc, int paramInt, boolean paramBoolean)
  {
    ...
    com.b.a.b.a.d locald = paramc.e();
    e locale1;
    e locale2;
    h localh;
    if ((locald == com.b.a.b.a.d.e) || (locald == com.b.a.b.a.d.f))
    {
      locale1 = new e(paramBitmap.getWidth(), paramBitmap.getHeight(), paramInt);
      locale2 = paramc.d();
      localh = paramc.f();
      if (locald != com.b.a.b.a.d.f) {
        break label257;
      }
    }
    label257:
    ...
    {
      float f1 = com.b.a.c.b.b(locale1, locale2, localh, bool);
      if (Float.compare(f1, 1.0F) != 0)
      {
        localMatrix.setScale(f1, f1);
        if (this.g) {
          com.b.a.c.d.a("Scale subsampled image (%1$s) to %2$s (scale = %3$.5f) [%4$s]", new Object[] { locale1, locale1.a(f1), Float.valueOf(f1), paramc.a() });
        }
      }
      if (paramBoolean)
      {
        ...
        if (this.g) {
          com.b.a.c.d.a("Flip image horizontally [%s]", new Object[] { paramc.a() });
        }
      }
      if (paramInt != 0)
      {
        ...
        if (this.g) {
          com.b.a.c.d.a("Rotate image on %1$d° [%2$s]", new Object[] { Integer.valueOf(paramInt), paramc.a() });
        }
      }
  ...
  public Bitmap a(c paramc)
  {
    ...
    {
      com.b.a.c.d.d("No stream for image [%s]", new Object[] { paramc.a() });
      return null;
    }
    ...
    try
    {
      ...
      com.b.a.c.c.a(localInputStream2);
      if (localBitmap == null)
      {
        com.b.a.c.d.d("Image can't be decoded [%s]", new Object[] { paramc.a() });
        return localBitmap;
      }
    }
    finally
    {
      com.b.a.c.c.a(localInputStream1);
    }
  ...
  {
    com.b.a.b.a.d locald = paramc.e();
    if (locald == com.b.a.b.a.d.a) {}
    for (int i = 1;; i = com.b.a.c.b.a(parame))
    {
      if ((i > 1) && (this.g)) {
        com.b.a.c.d.a("Subsample original image (%1$s) to %2$s (scale = %3$d) [%4$s]", new Object[] { parame, parame.a(i), Integer.valueOf(i), paramc.a() });
      }
      parame = paramc.j();
      parame.inSampleSize = i;
      return parame;
      if (locald != com.b.a.b.a.d.b) {
        break;
      }
    }
    e locale = paramc.d();
    if (locald == com.b.a.b.a.d.c) {}
    for (boolean bool = true;; bool = false)
    {
      i = com.b.a.c.b.a(parame, locale, paramc.f(), bool);
      break;
    }
  }
  ...
  protected a a(String paramString)
  {
    ...
    catch (IOException localIOException)
    {
      ...
      {
        int i;
        com.b.a.c.d.c("Can't read EXIF tags from file [%s]", new Object[] { paramString });
      }
    }
    bool1 = false;
    i = j;
  ...
  protected b a(InputStream paramInputStream, c paramc)
  {
    ...
    if ((paramc.i()) && (a(paramInputStream, localOptions.outMimeType))) {}
  ...
  protected InputStream b(InputStream paramInputStream, c paramc)
  {
    ...
    {
      com.b.a.c.c.a(paramInputStream);
    }
    return b(paramc);
  }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/b/a/b/b/a.class

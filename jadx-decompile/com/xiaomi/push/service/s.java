...
public class s {
    ...
    public static ab a(Context context, ab abVar, boolean z, boolean z2, boolean z3) {
        ...
        wVar.b(aq.a(z, z2, z3));
        ab a = aa.a(abVar.j(), abVar.h(), wVar, com.xiaomi.xmpush.thrift.a.f);
        m = abVar.m().a();
    ...
    private static void a(XMPushService xMPushService, byte[] bArr, long j) {
        ...
        if (a != null) {
            ...
            String str;
            if (com.xiaomi.xmpush.thrift.a.e == a.a() && p.a(xMPushService).a(a.f) && !ac.b(a)) {
                str = "";
                if (m != null) {
                    str = m.b();
                }
            ...
            } else if (com.xiaomi.xmpush.thrift.a.e == a.a() && p.a(xMPushService).c(a.f) && !ac.b(a)) {
                str = "";
                if (m != null) {
                    str = m.b();
                }
    ...
    private static boolean b(XMPushService xMPushService, ab abVar) {
        ...
        if (com.xiaomi.channel.commonutils.android.b.f(xMPushService, abVar.f)) {
            Map s = abVar.m().s();
            return s == null ? false : !"12".contains((CharSequence) s.get("__geo_action")) ? false : !TextUtils.isEmpty((CharSequence) s.get("__geo_ids"));
        } else {

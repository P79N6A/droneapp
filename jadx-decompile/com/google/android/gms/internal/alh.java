...
public interface alh extends IInterface {
    ...
    public static abstract class a extends Binder implements alh {

        private static class a implements alh {
            private IBinder a;
        ...
        public static alh a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IGoogleFitRecordingApi");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alh)) ? new a(iBinder) : (alh) queryLocalInterface;
        }

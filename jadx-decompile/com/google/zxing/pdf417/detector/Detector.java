...
public final class Detector {
    ...
    private static void correctCodeWordVertices(ResultPoint[] resultPointArr, boolean z) {
        ...
        if (y > 2.0f) {
            ...
            x = resultPointArr[2].getX() - resultPointArr[4].getX();
            resultPointArr[6] = new ResultPoint(resultPointArr[6].getX(), resultPointArr[6].getY() - (((resultPointArr[2].getX() - resultPointArr[6].getX()) * (resultPointArr[2].getY() - resultPointArr[4].getY())) / x));
        }
    ...
    private static ResultPoint[] findVertices(BitMatrix bitMatrix) {
        ...
        if (i2 != 0) {
            for (i = 0; i < height; i++) {
                ...
                if (findGuardPattern != null) {
                    resultPointArr[2] = new ResultPoint((float) findGuardPattern[1], (float) i);
    ...
    private static ResultPoint[] findVertices180(BitMatrix bitMatrix) {
        ...
        if (z) {
            for (i2 = height - 1; i2 > 0; i2--) {
                ...
                if (findGuardPattern != null) {
                    resultPointArr[2] = new ResultPoint((float) findGuardPattern[0], (float) i2);

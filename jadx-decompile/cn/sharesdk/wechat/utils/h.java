...
public class h {
    ...
    private String a(String str) {
        try {
            Cursor query = this.a.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.plugin.provider/sharedpref"), new String[]{k._ID, "key", "type", "value"}, "key = ?", new String[]{str}, null);
            if (query == null) {
                return null;
            }
    ...
    private boolean d() {
        ...
        try {
            for (Signature toCharsString : this.a.getPackageManager().getPackageInfo(PluginIntent.APP_PACKAGE_PATTERN, 64).signatures) {
    ...
    public boolean a() {
        String str;
        try {
            str = this.a.getPackageManager().getPackageInfo(PluginIntent.APP_PACKAGE_PATTERN, 0).versionName;
    ...
    public boolean a(Context context, String str) {
        ...
        if (d()) {
            ...
            intent.putExtra(ConstantsMMessage.CHECK_SUM, a(str3, packageName, 553910273));
    ...
    public boolean a(WechatHandlerActivity wechatHandlerActivity, i iVar) {
        ...
        if (a(intent.getByteArrayExtra(ConstantsMMessage.CHECK_SUM), a(intent.getStringExtra(ConstantsMMessage.CONTENT), stringExtra2, intent.getIntExtra(ConstantsMMessage.SDK_VERSION, 0)))) {

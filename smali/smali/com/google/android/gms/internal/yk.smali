...
.method public constructor <init>(Lcom/google/android/gms/internal/acy;Ljava/util/Map;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/yk;->a:Ljava/util/Map;

    invoke-interface {p1}, Lcom/google/android/gms/internal/acy;->f()Landroid/app/Activity;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/internal/yk;->b:Landroid/content/Context;

    return-void
.end method

.method static synthetic a(Lcom/google/android/gms/internal/yk;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/internal/yk;->b:Landroid/content/Context;
...
.method a(Ljava/lang/String;Ljava/lang/String;)Landroid/app/DownloadManager$Request;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/abw;->a(Landroid/app/DownloadManager$Request;)Z
...
.method public a()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/yk;->b(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/yk;->b:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lcom/google/android/gms/internal/abv;->e(Landroid/content/Context;)Lcom/google/android/gms/internal/tx;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/gms/internal/tx;->c()Z
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/yk;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/gms/internal/abv;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/internal/abl;->q()Landroid/content/res/Resources;
    ...
    iget-object v4, p0, Lcom/google/android/gms/internal/yk;->b:Landroid/content/Context;

    invoke-virtual {v1, v4}, Lcom/google/android/gms/internal/abv;->d(Landroid/content/Context;)Landroid/app/AlertDialog$Builder;
    ...
    :goto_5
    new-instance v5, Lcom/google/android/gms/internal/yk$1;

    invoke-direct {v5, p0, v0, v2}, Lcom/google/android/gms/internal/yk$1;-><init>(Lcom/google/android/gms/internal/yk;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_6
    new-instance v1, Lcom/google/android/gms/internal/yk$2;

    invoke-direct {v1, p0}, Lcom/google/android/gms/internal/yk$2;-><init>(Lcom/google/android/gms/internal/yk;)V

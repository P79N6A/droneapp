  ...
  extends Platform
{
  ...
  protected void doAuthorize(final String[] paramArrayOfString)
  {
    paramArrayOfString = b.a(this);
    paramArrayOfString.a(this.a, this.b, this.c);
    paramArrayOfString.a(new AuthorizeListener()
    {
      public void onCancel()
      {
        if (Twitter.g(Twitter.this) != null) {
          Twitter.h(Twitter.this).onCancel(Twitter.this, 1);
        }
      }
      
      public void onComplete(Bundle paramAnonymousBundle)
      {
        String str1 = paramAnonymousBundle.getString("oauth_token");
        String str2 = paramAnonymousBundle.getString("oauth_token_secret");
        String str3 = paramAnonymousBundle.getString("user_id");
        paramAnonymousBundle = paramAnonymousBundle.getString("screen_name");
        Twitter.a(Twitter.this).putToken(str1);
        Twitter.b(Twitter.this).putTokenSecret(str2);
        Twitter.c(Twitter.this).putUserId(str3);
        Twitter.d(Twitter.this).put("nickname", paramAnonymousBundle);
        paramArrayOfString.a(str1, str2);
        Twitter.a(Twitter.this, 1, null);
      }
      
      public void onError(Throwable paramAnonymousThrowable)
      {
        if (Twitter.e(Twitter.this) != null) {
          Twitter.f(Twitter.this).onError(Twitter.this, 1, paramAnonymousThrowable);
        }
      }
    });
  }
  ...
  protected void doCustomerProtocol(String paramString1, String paramString2, int paramInt, HashMap<String, Object> paramHashMap, HashMap<String, String> paramHashMap1)
  {
    ...
    try
    {
      paramString1 = localb.a(paramString1, paramString2, paramHashMap, paramHashMap1);
      ...
      do
      {
        for (;;)
        {
          try
          {
            ...
            {
              localHashMap = localb.a(str1, (String[])localObject);
          ...
          {
            localHashMap = localb.e(str1, str2);
          }
          else if (!TextUtils.isEmpty(str3))
          {
            localObject = BitmapHelper.downloadBitmap(getContext(), str3);
            if (new File((String)localObject).exists()) {
              localHashMap = localb.e(str1, (String)localObject);
            }
          }
          else
          {
            localHashMap = localb.c(str1);
          }
        }
    ...
    for (String str1 = this.db.getUserId();; str1 = null)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramString = localb.c(str2, str1);
    ...
    for (String str1 = this.db.getUserId();; str1 = null)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramString = localb.b(str2, str1);
          if ((paramString != null) && (paramString.size() > 0) && (!paramString.containsKey("error_code")) && (!paramString.containsKey("error")))
          {
  ...
  protected void userInfor(String paramString)
  {
    ...
    try
    {
      localObject = ((b)localObject).b(paramString);
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/twitter/Twitter.class

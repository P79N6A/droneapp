  ...
  extends LinearLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      if ((n > this.mLastWidthSize) && (isStacked())) {
        setStacked(false);
      }
      this.mLastWidthSize = n;
    }
    int j;
    int i;
    int k;
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/widget/ButtonBarLayout.class

...
public abstract class BasicDeserializerFactory extends DeserializerFactory {
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationConfig deserializationConfig, BasicBeanDescription basicBeanDescription, String str, int i, AnnotatedParameter annotatedParameter) {
        ...
        SettableBeanProperty settableBeanProperty$CreatorProperty = new SettableBeanProperty$CreatorProperty(str, modifyTypeByAnnotation, findTypeDeserializer(deserializationConfig, modifyTypeByAnnotation, std), basicBeanDescription.getClassAnnotations(), annotatedParameter, i);
        if (findDeserializerFromAnnotation != null) {
            settableBeanProperty$CreatorProperty.setValueDeserializer(findDeserializerFromAnnotation);
        }
        return settableBeanProperty$CreatorProperty;
    }
    ...
    public abstract DeserializerFactory withConfig(DeserializerFactory$Config deserializerFactory$Config);
}

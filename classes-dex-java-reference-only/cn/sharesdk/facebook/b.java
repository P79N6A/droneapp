  ...
  extends d
{
  ...
  private void d(Intent paramIntent)
  {
    if (paramIntent != null)
    {
      ...
      paramIntent = paramIntent.getStringExtra("error_code");
      paramIntent = new Throwable(str + " (" + paramIntent + ")");
      if (this.c != null) {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/facebook/b.class

...
public final class FermiMediaManager {
    ...
    public void showPopVideoView(String str) {
        final Dialog fermiPlayerDialog = new FermiPlayerDialog(getContext(), R.style.videoDialog);
        ...
        fermiPlayerDialog.setContentView(FermiPlayerViewBuilder.Builder(getContext(), R.layout.layout_videoview_popup).setFermiMediaPlayer(createFermiMediaPlayer).setOnClickCloseListenner(new OnClickCloseListener() {
    ...
    public void showPopVideoViewWithNoSeekBar(String str) {
        this.dialog = new FermiPlayerDialog(getContext(), R.style.videoDialog);
        final IFermiMediaPlayer createFermiMediaPlayer = createFermiMediaPlayer(FermiMediaPlayerType.SystemMediaPlayer);
        createFermiMediaPlayer.setAutoPlay(true);
        this.dialog.setContentView(FermiPlayerViewBuilder.Builder(getContext(), R.layout.layout_videoview_popup).setFermiMediaPlayer(createFermiMediaPlayer).setOnClickCloseListenner(new OnClickCloseListener() {
            public void onClose(View view) {
                createFermiMediaPlayer.stop();

...
public class g
{
  ...
  public void a(final String paramString, final AuthorizeListener paramAuthorizeListener)
  {
  ...
  {
    Object localObject = new ArrayList();
    ((ArrayList)localObject).add(new KVPair("appid", this.a));
    ((ArrayList)localObject).add(new KVPair("refresh_token", this.d.getDb().get("refresh_token")));
    ((ArrayList)localObject).add(new KVPair("grant_type", "refresh_token"));
    try
    {
      localObject = this.c.a("https://api.weixin.qq.com/sns/oauth2/refresh_token", (ArrayList)localObject, "/sns/oauth2/refresh_token", this.e);
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        return false;
      }
      if (!((String)localObject).contains("errcode"))
      {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/wechat/utils/g.class

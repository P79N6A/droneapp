...
public class a {
    ...
    public static d a(XmlPullParser xmlPullParser) {
        ...
        try {
            attributeValue7 = xmlPullParser.getAttributeValue("", "seq");
    ...
    public static f b(XmlPullParser xmlPullParser) {
        f$b com_xiaomi_smack_packet_f_b = f$b.available;
        String attributeValue = xmlPullParser.getAttributeValue("", "type");
        if (!(attributeValue == null || attributeValue.equals(""))) {
            try {
                com_xiaomi_smack_packet_f_b = f$b.valueOf(attributeValue);
            } catch (IllegalArgumentException e) {
                System.err.println("Found invalid presence type " + attributeValue);
            }
        }
        f fVar = new f(com_xiaomi_smack_packet_f_b);
    ...
    public static h d(XmlPullParser xmlPullParser) {
        ...
        while (i < xmlPullParser.getAttributeCount()) {
            attributeValue = xmlPullParser.getAttributeName(i).equals(XiaomiOAuthConstants.EXTRA_CODE_2) ? xmlPullParser.getAttributeValue("", XiaomiOAuthConstants.EXTRA_CODE_2) : str4;

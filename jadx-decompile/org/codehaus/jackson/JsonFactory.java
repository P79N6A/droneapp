...
public class JsonFactory implements Versioned {
    ...
    @Deprecated
    public final void disableGeneratorFeature(Feature feature) {
        disable(feature);
    }
    ...
    @Deprecated
    public final void enableGeneratorFeature(Feature feature) {
        enable(feature);
    }
    ...
    @Deprecated
    public final boolean isGeneratorFeatureEnabled(Feature feature) {
    ...
    @Deprecated
    public final void setGeneratorFeature(Feature feature, boolean z) {
        configure(feature, z);
    }

  ...
  extends b
{
  ...
  private void b(RelativeLayout paramRelativeLayout, float paramFloat)
  {
    ...
    paramRelativeLayout.setOrientation(1);
    ...
    int j = (int)(300.0F * paramFloat);
    int k = (int)(70.0F * paramFloat);
  ...
  {
    super.onCreate();
    float f = R.getScreenHeight(this.activity) / 1280.0F;
    this.p = 0;
    ...
    Object localObject1 = new LinearLayout.LayoutParams(-1, (int)(96.0F * f));
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/fimi/soul/module/a/a/a/b/a.class

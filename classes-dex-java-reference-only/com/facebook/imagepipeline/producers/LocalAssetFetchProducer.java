  ...
  extends LocalFetchProducer
{
  ...
  private int getLength(ImageRequest paramImageRequest)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 18	com/facebook/imagepipeline/producers/LocalAssetFetchProducer:mAssetManager	Landroid/content/res/AssetManager;
    //   4: aload_1
    //   5: invokestatic 45	com/facebook/imagepipeline/producers/LocalAssetFetchProducer:getAssetName	(Lcom/facebook/imagepipeline/request/ImageRequest;)Ljava/lang/String;
    //   8: invokevirtual 51	android/content/res/AssetManager:openFd	(Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    //   11: astore_1
    //   12: aload_1
    //   13: invokevirtual 56	android/content/res/AssetFileDescriptor:getLength	()J
    //   16: lstore 4
    //   18: lload 4
    //   20: l2i
    //   21: istore_3
    ...
    //   25: ifnull +9 -> 34
    //   28: aload_1
    //   29: invokevirtual 60	android/content/res/AssetFileDescriptor:close	()V
    //   32: iload_3
    //   33: istore_2
    //   34: iload_2
    //   35: ireturn
    ...
    //   42: ifnull -8 -> 34
    //   45: aload_1
    //   46: invokevirtual 60	android/content/res/AssetFileDescriptor:close	()V
    //   49: iconst_m1
    //   50: ireturn
    //   51: astore_1
    //   52: iconst_m1
    ...
    //   59: ifnull +7 -> 66
    //   62: aload_1
    //   63: invokevirtual 60	android/content/res/AssetFileDescriptor:close	()V
    //   66: aload 6
    //   68: athrow
    //   69: astore_1
    //   70: iload_3
    ...
    //   81	1	6	localIOException	java.io.IOException
    // Exception table:
    //   from	to	target	type
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/producers/LocalAssetFetchProducer.class

...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float lerp4 = lerp(i != 0 ? 0.0f : -180.0f, i != 0 ? b.e : 0.0f, this.mProgress);
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (c.a * round2)) - (this.mBarGap * 2.0f))) / 4) * 2))) + ((((double) round2) * 1.5d) + ((double) this.mBarGap))));
        if (this.mSpin) {

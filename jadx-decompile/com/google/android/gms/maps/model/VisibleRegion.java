...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        return c.a(new Object[]{this.a, this.b, this.c, this.d, this.e});
    }

    public String toString() {
        return c.a(this).a("nearLeft", this.a).a("nearRight", this.b).a("farLeft", this.c).a("farRight", this.d).a("latLngBounds", this.e).toString();
    }

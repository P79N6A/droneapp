  ...
  implements Supplier<DataSource<T>>
{
    ...
    extends AbstractDataSource<T>
  {
    ...
    private DataSource<T> getDataSource(int paramInt)
    {
      ...
      //   14: invokevirtual 102	java/util/ArrayList:size	()I
      //   17: if_icmpge +19 -> 36
      //   20: aload_0
      ...
      //   24: iload_1
      //   25: invokevirtual 110	java/util/ArrayList:get	(I)Ljava/lang/Object;
    ...
    private DataSource<T> tryGetAndClearDataSource(int paramInt, DataSource<T> paramDataSource)
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: invokespecial 119	com/facebook/datasource/IncreasingQualityDataSourceSupplier$IncreasingQualityDataSource:getDataSourceWithResult	()Lcom/facebook/datasource/DataSource;
      //   6: astore_3
      //   7: aload_2
      //   8: aload_3
      //   9: if_acmpne +9 -> 18
      ...
      //   21: aload_0
      //   22: iload_1
      //   23: invokespecial 114	com/facebook/datasource/IncreasingQualityDataSourceSupplier$IncreasingQualityDataSource:getDataSource	(I)Lcom/facebook/datasource/DataSource;
      //   26: if_acmpne -12 -> 14
      //   29: aload_0
      //   30: iload_1
      //   31: invokespecial 121	com/facebook/datasource/IncreasingQualityDataSourceSupplier$IncreasingQualityDataSource:getAndClearDataSource	(I)Lcom/facebook/datasource/DataSource;
      //   34: astore_3
      //   35: goto -21 -> 14
      //   38: astore_2
      //   39: aload_0
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/datasource/IncreasingQualityDataSourceSupplier.class

...
public class ImagePipeline
{
  ...
  public DataSource<Boolean> isInDiskCache(final ImageRequest paramImageRequest)
  {
    ...
    this.mMainBufferedDiskCache.contains(paramImageRequest).b(new j()
    {
      public l<Boolean> then(l<Boolean> paramAnonymousl)
      {
        if ((!paramAnonymousl.c()) && (!paramAnonymousl.d()) && (((Boolean)paramAnonymousl.e()).booleanValue())) {
    ...
    {
      public Void then(l<Boolean> paramAnonymousl)
      {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/core/ImagePipeline.class

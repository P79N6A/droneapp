...
public class a
{
  ...
  private ArrayList<KVPair<String>> a(String paramString1, String paramString2, ArrayList<KVPair<String>> paramArrayList, a parama)
  {
    ...
    for (;;)
    {
      ...
      paramString2 = new String(Base64.encode(localMac.doFinal((paramString2 + '&' + a(paramString1) + '&' + a(paramArrayList)).getBytes("utf-8")), 0)).trim();
      paramString1 = parama;
      continue;
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/framework/utils/a.class

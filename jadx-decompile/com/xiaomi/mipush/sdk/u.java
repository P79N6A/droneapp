...
public class u {
    ...
    private final void a(String str, boolean z) {
        ...
        if (a.a(this.c).b() && d.d(this.c)) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                aeVar = new ae(generatePacketID, true);
                synchronized (p.class) {
                    p.a(this.c).a((String) generatePacketID);
                }
            } else {
                aeVar2.a(str);
            ...
            a(aeVar2, a.Notification, false, null);
            aeVar.b(a.a(this.c).c());
            aeVar.d(this.c.getPackageName());
            byte[] a = aq.a(q.a(this.c, aeVar, a.Notification, false, this.c.getPackageName(), a.a(this.c).c()));
            if (a != null) {
                i2.putExtra("mipush_payload", a);
            ...
            obtain.arg1 = i;
            this.f.sendMessageDelayed(obtain, 5000);
        }
    }
    ...
    public final void a(af afVar, boolean z) {
        this.g = null;
        Intent i = i();
        byte[] a = aq.a(q.a(this.c, afVar, a.Registration));
        if (a == null) {
    ...
    public final void a(com.xiaomi.xmpush.thrift.am amVar) {
        Intent i = i();
        byte[] a = aq.a(q.a(this.c, amVar, a.UnRegistration));
        if (a == null) {
    ...
    public final <T extends org.a.b.a<T, ?>> void a(T t, a aVar, r rVar) {
        a(t, aVar, !aVar.equals(a.Registration), rVar);
    }

    public <T extends org.a.b.a<T, ?>> void a(T t, a aVar, boolean z) {
        a aVar2 = new a();
        aVar2.a = t;
        aVar2.b = aVar;
        aVar2.c = z;
    ...
    public final <T extends org.a.b.a<T, ?>> void a(T t, a aVar, boolean z, r rVar) {
        a(t, aVar, z, true, rVar, true);
    }

    public final <T extends org.a.b.a<T, ?>> void a(T t, a aVar, boolean z, r rVar, boolean z2) {
        a(t, aVar, z, true, rVar, z2);
    }

    public final <T extends org.a.b.a<T, ?>> void a(T t, a aVar, boolean z, boolean z2, r rVar, boolean z3) {
        a(t, aVar, z, z2, rVar, z3, this.c.getPackageName(), a.a(this.c).c());
    }

    public final <T extends org.a.b.a<T, ?>> void a(T t, a aVar, boolean z, boolean z2, r rVar, boolean z3, String str, String str2) {
        if (a.a(this.c).i()) {
            Intent i = i();
            org.a.b.a a = q.a(this.c, t, aVar, z, str, str2);
            if (rVar != null) {
                a.a(rVar);
            }
            byte[] a2 = aq.a(a);

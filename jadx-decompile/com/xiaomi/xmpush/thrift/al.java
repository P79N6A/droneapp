...
public class al implements Serializable, Cloneable, org.a.b.a<al, a> {
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, ak.class)));
    ...
    public int b(al alVar) {
        ...
        if (a()) {
            compareTo = org.a.b.b.a(this.a, alVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (b()) {
            compareTo = org.a.b.b.a(this.b, alVar.b);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (c()) {
            compareTo = org.a.b.b.a(this.c, alVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.a.b.b.a(this.d, alVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.a.b.b.a(this.e, alVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (f()) {
            compareTo = org.a.b.b.a(this.f, alVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.a.b.b.a(this.g, alVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (i()) {
            compareTo = org.a.b.b.a(this.h, alVar.h);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (j()) {
            compareTo = org.a.b.b.a(this.i, alVar.i);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (l()) {
            compareTo = org.a.b.b.a(this.j, alVar.j);
            if (compareTo != 0) {
                return compareTo;
            }
        }

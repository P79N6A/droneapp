...
public class ai implements Serializable, Cloneable, org.a.b.a<ai, a> {
    ...
    private static final org.a.b.b.b r = new org.a.b.b.b("category", (byte) 11, (short) 8);
    public String a;
    public u b;
    public String c;
    public String d;
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, ah.class)));
    ...
    public int b(ai aiVar) {
        ...
        if (a()) {
            compareTo = org.a.b.b.a(this.a, aiVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (b()) {
            compareTo = org.a.b.b.a(this.b, aiVar.b);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (c()) {
            compareTo = org.a.b.b.a(this.c, aiVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.a.b.b.a(this.d, aiVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.a.b.b.a(this.e, aiVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (f()) {
            compareTo = org.a.b.b.a(this.f, aiVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.a.b.b.a(this.g, aiVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (h()) {
            compareTo = org.a.b.b.a(this.h, aiVar.h);
            if (compareTo != 0) {
                return compareTo;
            }
        }

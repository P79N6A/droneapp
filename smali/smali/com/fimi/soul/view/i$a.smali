...
.method public a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/fimi/soul/biz/modifyRealyWiFiConfigure/ModifyRelayWiFi;->getSsid()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0}, Lcom/fimi/soul/biz/modifyRealyWiFiConfigure/ModifyRelayWiFi;->getPassword()Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lcom/fimi/soul/biz/e/d;->e(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/fimi/soul/biz/e/d;->d(Ljava/lang/String;)V
...
.method public c()Lcom/fimi/soul/view/i;
    ...
    iput-object v1, p0, Lcom/fimi/soul/view/i$a;->g:Landroid/widget/EditText;

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->g:Landroid/widget/EditText;

    invoke-virtual {v1}, Landroid/widget/EditText;->clearFocus()V

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->j:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->g:Landroid/widget/EditText;

    iget-object v2, p0, Lcom/fimi/soul/view/i$a;->j:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/fimi/soul/view/i$a;->h:Landroid/widget/EditText;

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->h:Landroid/widget/EditText;

    invoke-virtual {v1}, Landroid/widget/EditText;->clearFocus()V

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->k:Ljava/lang/String;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->h:Landroid/widget/EditText;

    iget-object v2, p0, Lcom/fimi/soul/view/i$a;->k:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/fimi/soul/view/i$a;->i:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lcom/fimi/soul/view/i$a;->c:Ljava/lang/String;
    ...
    :cond_2
    iget-object v4, p0, Lcom/fimi/soul/view/i$a;->d:Ljava/lang/String;
    ...
    :cond_3
    iget-object v4, p0, Lcom/fimi/soul/view/i$a;->e:Landroid/content/DialogInterface$OnClickListener;

    if-eqz v4, :cond_4

    new-instance v4, Lcom/fimi/soul/view/i$a$1;

    invoke-direct {v4, p0}, Lcom/fimi/soul/view/i$a$1;-><init>(Lcom/fimi/soul/view/i$a;)V

    invoke-virtual {v1, v4}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_4
    iget-object v4, p0, Lcom/fimi/soul/view/i$a;->f:Landroid/content/DialogInterface$OnClickListener;

    if-eqz v4, :cond_5

    new-instance v4, Lcom/fimi/soul/view/i$a$2;

    invoke-direct {v4, p0}, Lcom/fimi/soul/view/i$a$2;-><init>(Lcom/fimi/soul/view/i$a;)V

    invoke-virtual {v2, v4}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_5
    iget-object v4, p0, Lcom/fimi/soul/view/i$a;->b:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/fimi/soul/view/i$a;->g:Landroid/widget/EditText;

    aput-object v6, v5, v0

    const/4 v0, 0x2

    iget-object v6, p0, Lcom/fimi/soul/view/i$a;->h:Landroid/widget/EditText;
    ...
    iget-object v1, p0, Lcom/fimi/soul/view/i$a;->i:Landroid/widget/TextView;

    aput-object v1, v5, v0

    invoke-static {v4, v5}, Lcom/fimi/soul/utils/ao;->a(Landroid/content/res/AssetManager;[Landroid/view/View;)V

    iget-object v0, p0, Lcom/fimi/soul/view/i$a;->a:Lcom/fimi/soul/view/i;

    invoke-virtual {v0, v3}, Lcom/fimi/soul/view/i;->setContentView(Landroid/view/View;)V

...
public interface yx extends IInterface {
    ...
    public static abstract class a extends Binder implements yx {

        private static class a implements yx {
            private IBinder a;
        ...
        public static yx a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof yx)) ? new a(iBinder) : (yx) queryLocalInterface;
        }

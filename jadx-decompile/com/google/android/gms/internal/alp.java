...
public interface alp extends IInterface {
    ...
    public static abstract class a extends Binder implements alp {
        ...
        public static alp a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.ISessionStopCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alp)) ? new a(iBinder) : (alp) queryLocalInterface;
        }

...
public class CustomSerializerFactory extends BeanSerializerFactory {
    ...
    public CustomSerializerFactory(SerializerFactory$Config serializerFactory$Config) {
        super(serializerFactory$Config);
    ...
    public SerializerFactory withConfig(SerializerFactory$Config serializerFactory$Config) {
        if (getClass() == CustomSerializerFactory.class) {
            return new CustomSerializerFactory(serializerFactory$Config);
        }

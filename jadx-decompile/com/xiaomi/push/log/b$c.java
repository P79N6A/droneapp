...
class b$c extends b$b {
    ...
    private boolean f() {
        ...
        try {
            ...
            currentTimeMillis = jSONObject.getLong(a.i);
        ...
        try {
            jSONObject2.put(a.i, currentTimeMillis);
    ...
    public void b() {
        try {
            if (f()) {
                ...
                hashMap.put("net", d.k(b.a(this.g)));
                d.a(this.a, hashMap, this.c, UriUtil.LOCAL_FILE_SCHEME);
            }
            this.e = true;
        } catch (IOException e) {
        }
    ...
    public boolean d() {
        return d.f(b.a(this.g)) || (this.f && d.d(b.a(this.g)));
    }
}

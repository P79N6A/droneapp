...
public class QQAuth
{
    ...
    for (paramString2 = localApplicationInfo.sourceDir;; paramString2 = null)
    {
      if (paramString2 != null) {
        try
        {
          ...
          {
            f.b(f.d, "-->login channelId: " + paramString2);
        ...
        {
          f.b(f.d, "-->login get channel id exception." + paramString2.getMessage());
  ...
  public static QQAuth createInstance(String paramString, Context paramContext)
  {
    ...
    {
      f.b(f.d, "createInstance() error --end", paramString);
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/connect/auth/QQAuth.class

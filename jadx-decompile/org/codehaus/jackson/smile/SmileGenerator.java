...
public class SmileGenerator extends JsonGeneratorBase {
            ...
            if (this._seenNameCount == 1024) {
                ...
                for (SharedStringNode sharedStringNode : sharedStringNodeArr) {
                    for (SharedStringNode sharedStringNode2 = sharedStringNodeArr[r1]; sharedStringNode2 != null; sharedStringNode2 = sharedStringNode2.next) {
                        int hashCode = sharedStringNode2.value.hashCode() & d.bp;
    ...
    private void _mediumUTF8Encode(char[] cArr, int i, int i2) {
        ...
        while (i4 < i2) {
            ...
            if (i6 < 2048) {
            ...
            } else if (i6 < SURR1_FIRST || i6 > SURR2_LAST) {
                bArr = this._outputBuffer;
                i7 = this._outputTail;
                this._outputTail = i7 + 1;
                ...
                i5 = i4 + 1;
                i4 = _convertSurrogate(i6, cArr[i4]);
                if (i4 > 1114111) {
                ...
                i7 = this._outputTail;
                this._outputTail = i7 + 1;
                bArr2[i7] = (byte) ((i4 >> 18) | 240);
                bArr2 = this._outputBuffer;
                i7 = this._outputTail;
                this._outputTail = i7 + 1;
                bArr2[i7] = (byte) (((i4 >> 12) & 63) | 128);
                bArr2 = this._outputBuffer;
                i7 = this._outputTail;
                this._outputTail = i7 + 1;
                bArr2[i7] = (byte) (((i4 >> 6) & 63) | 128);
                bArr2 = this._outputBuffer;
                i7 = this._outputTail;
                this._outputTail = i7 + 1;
    ...
    private void _slowUTF8Encode(String str) {
        ...
        while (i < length) {
            ...
            if (i4 < 2048) {
                ...
                this._outputTail = i5 + 1;
                bArr[i5] = (byte) ((i4 & 63) | 128);
            } else if (i4 < SURR1_FIRST || i4 > SURR2_LAST) {
                bArr = this._outputBuffer;
                i5 = this._outputTail;
                this._outputTail = i5 + 1;
                ...
                i3 = i + 1;
                i = _convertSurrogate(i4, str.charAt(i));
                if (i > 1114111) {
    ...
    public void writeNumber(double d) {
        ...
        i2 >>= 7;
        this._outputBuffer[this._outputTail + 2] = (byte) (i2 & 127);
        i2 >>= 7;
        this._outputBuffer[this._outputTail + 1] = (byte) (i2 & 127);
        ...
        this._outputBuffer[this._outputTail + 3] = (byte) (i4 & 127);
        i4 >>= 7;
    ...
    public void writeNumber(float f) {
        ...
        floatToRawIntBits >>= 7;
        this._outputBuffer[this._outputTail + 3] = (byte) (floatToRawIntBits & 127);
        floatToRawIntBits >>= 7;
        this._outputBuffer[this._outputTail + 2] = (byte) (floatToRawIntBits & 127);
        floatToRawIntBits >>= 7;
        this._outputBuffer[this._outputTail + 1] = (byte) (floatToRawIntBits & 127);
        this._outputBuffer[this._outputTail] = (byte) ((floatToRawIntBits >> 7) & 127);
        this._outputTail += 5;
    }
    ...
    public void writeNumber(int i) {
        ...
        if (zigzagEncode > 63 || zigzagEncode < 0) {
            ...
            byte b2 = (byte) (zigzagEncode & 127);
            zigzagEncode >>= 7;
            if (zigzagEncode <= 127) {
                _writeBytes(TOKEN_BYTE_INT_32, (byte) zigzagEncode, b2, b);
                return;
            }
            byte b3 = (byte) (zigzagEncode & 127);
            zigzagEncode >>= 7;
            if (zigzagEncode <= 127) {
                _writeBytes(TOKEN_BYTE_INT_32, (byte) zigzagEncode, b3, b2, b);
                return;
            }
            byte b4 = (byte) (zigzagEncode >> 7);
            _writeBytes(TOKEN_BYTE_INT_32, b4, (byte) (zigzagEncode & 127), b3, b2, b);
    ...
    public void writeNumber(long j) {
        if (j > MAX_INT_AS_LONG || j < MIN_INT_AS_LONG) {
            ...
            zigzagEncode >>>= 27;
            byte b5 = (byte) (((int) zigzagEncode) & 127);
            ...
            if (i2 == 0) {
                ...
                _writeBytes(TOKEN_BYTE_INT_64, (byte) (i2 >> 7), (byte) (i2 & 127), b8, b7);
                _writeBytes(b6, b5, b4, b3, b2, b);
                return;
            }
        }
        ...
        if (length == 0) {
            ...
            if (_shortUTF8Encode <= 64) {
                ...
                if (_shortUTF8Encode == length) {
                    ...
                    this._outputBuffer[_findSeenStringValue] = (byte) (_shortUTF8Encode + 126);
                    return;
                }
            }
    ...
    public final void writeString(SerializableString serializableString) {
        ...
        if (length2 <= 64) {
            ...
            _findSeenStringValue = length2 == length ? length2 + 63 : length2 + 126;
            byte[] bArr = this._outputBuffer;
            int i = this._outputTail;
            this._outputTail = i + 1;

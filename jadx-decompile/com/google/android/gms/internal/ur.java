...
public interface ur extends IInterface {
    ...
    public static abstract class a extends Binder implements ur {

        private static class a implements ur {
            private IBinder a;
            ...
            public void a(uq uqVar) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(uqVar != null ? uqVar.asBinder() : null);
        ...
        public static ur a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.customrenderedad.client.IOnCustomRenderedAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ur)) ? new a(iBinder) : (ur) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(com.google.android.gms.internal.uq.a.a(parcel.readStrongBinder()));

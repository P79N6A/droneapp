...
public class c
{
  ...
  public c(Platform paramPlatform, Context paramContext)
  {
  ...
  private boolean j()
  {
      ...
      try
      {
        ...
        if (ShareSDK.a((HashMap)localObject)) {
          if (!ShareSDK.b((HashMap)localObject))
          {
            ...
            d.a().i("Failed to parse network dev-info: " + (String)localObject, new Object[0]);
            return false;
          }
        }
      }
    ...
    String str = a(this.a.getPlatformId(), "covert_url", null);
    if (str != null) {
      str.trim();
    }
    if (!"false".equals(str)) {}
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/framework/c.class

.class public Lcom/fimi/soul/biz/l/g;
...
.field private f:Lcom/fimi/soul/biz/l/g$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/fimi/soul/biz/l/g;->c:Ljava/lang/String;

    iput-object v0, p0, Lcom/fimi/soul/biz/l/g;->d:Ljava/lang/String;

    iput-object v0, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/fimi/soul/biz/l/g;->a:Landroid/content/Context;
...
.method public a()Lcom/fimi/soul/entity/PlaneMsg;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/fimi/soul/biz/l/g;->a:Landroid/content/Context;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/fimi/soul/biz/g/a;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/fimi/soul/biz/g/a;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string v1, "https://awsusor0.fds.api.xiaomi.com"

    const-string v2, "2882303761517518920"

    const-string v3, "2882303761517518920"

    iget-object v4, p0, Lcom/fimi/soul/biz/l/g;->c:Ljava/lang/String;

    const-string v5, "XiaoMi"

    iget-object v6, p0, Lcom/fimi/soul/biz/l/g;->d:Ljava/lang/String;
    ...
    const-string v1, "awsusor0"

    invoke-virtual {v0, v1}, Lcom/xiaomi/infra/galaxy/fds/android/FDSClientConfiguration;->setRegionName(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/fimi/soul/biz/l/g;->b:Lcom/xiaomi/infra/galaxy/fds/android/GalaxyFDSClient;
    ...
    iget-object v0, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;
...
.method public a(Ljava/io/File;)Lcom/fimi/soul/entity/PlaneMsg;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/fimi/soul/biz/l/g;->b:Lcom/xiaomi/infra/galaxy/fds/android/GalaxyFDSClient;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lcom/fimi/soul/biz/l/g;->a()Lcom/fimi/soul/entity/PlaneMsg;
    ...
    const-string v4, "bucket-app-us"

    iget-object v5, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;
...
.method public a(Ljava/io/InputStream;Lcom/xiaomi/infra/galaxy/fds/android/model/ObjectMetadata;Lcom/xiaomi/infra/galaxy/fds/android/model/ProgressListener;)Lcom/fimi/soul/entity/PlaneMsg;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/fimi/soul/biz/l/g;->b:Lcom/xiaomi/infra/galaxy/fds/android/GalaxyFDSClient;
    ...
    const-string v1, "bucket-app-us"

    iget-object v4, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;
...
.method public a(Lcom/fimi/soul/biz/l/g$a;)V
    .locals 0

    iput-object p1, p0, Lcom/fimi/soul/biz/l/g;->f:Lcom/fimi/soul/biz/l/g$a;
...
.method public b(Ljava/io/File;Lcom/xiaomi/infra/galaxy/fds/android/model/ProgressListener;)Lcom/fimi/soul/entity/PlaneMsg;
    ...
    invoke-static {v0, v10}, Lcom/fimi/soul/biz/g/a;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, v10}, Lcom/fimi/soul/biz/g/a;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    new-instance v1, Lcom/fimi/soul/biz/l/d;

    invoke-direct {v1}, Lcom/fimi/soul/biz/l/d;-><init>()V

    invoke-virtual {v1, v0}, Lcom/fimi/soul/biz/l/d;->b(Lcom/xiaomi/infra/galaxy/fds/android/auth/GalaxyFDSCredential;)Lcom/fimi/soul/biz/l/d;

    move-result-object v0

    const-string v1, "https://awsusor0.fds.api.xiaomi.com"

    invoke-virtual {v0, v1}, Lcom/fimi/soul/biz/l/d;->b(Ljava/lang/String;)Lcom/fimi/soul/biz/l/d;

    move-result-object v0

    const/high16 v1, 0x500000

    invoke-virtual {v0, v1}, Lcom/fimi/soul/biz/l/d;->g(I)V

    const-string v1, "awsusor0"

    invoke-virtual {v0, v1}, Lcom/fimi/soul/biz/l/d;->e(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;

    invoke-interface {v2, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/fimi/soul/biz/l/h;

    invoke-direct {v1, v0}, Lcom/fimi/soul/biz/l/h;-><init>(Lcom/fimi/soul/biz/l/d;)V

    iget-object v0, p0, Lcom/fimi/soul/biz/l/g;->f:Lcom/fimi/soul/biz/l/g$a;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/fimi/soul/biz/l/g;->f:Lcom/fimi/soul/biz/l/g$a;

    invoke-interface {v0, v1}, Lcom/fimi/soul/biz/l/g$a;->a(Lcom/fimi/soul/biz/l/h;)V

    :cond_0
    const-string v0, "bucket-app-us"

    iget-object v2, p0, Lcom/fimi/soul/biz/l/g;->e:Ljava/util/List;

    invoke-virtual {v1, v0, p1, v2, p2}, Lcom/fimi/soul/biz/l/h;->a(Ljava/lang/String;Ljava/io/File;Ljava/util/List;Lcom/xiaomi/infra/galaxy/fds/android/model/ProgressListener;)V

    const-string v0, "bucket-app-us"

    invoke-virtual {v8, v0}, Lcom/fimi/soul/entity/FdsMsg;->setBucketName(Ljava/lang/String;)V

    invoke-virtual {v1}, Lcom/fimi/soul/biz/l/h;->b()Lcom/fimi/soul/biz/l/f;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/fimi/soul/biz/l/f;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v8, v1}, Lcom/fimi/soul/entity/FdsMsg;->setObjectName(Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/fimi/soul/biz/l/f;->d()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v8, v1}, Lcom/fimi/soul/entity/FdsMsg;->setUrl(Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/fimi/soul/biz/l/f;->a()Z

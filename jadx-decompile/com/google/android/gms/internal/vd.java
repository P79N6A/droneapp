...
public interface vd extends IInterface {
    ...
    public static abstract class a extends Binder implements vd {

        private static class a implements vd {
            private IBinder a;
        ...
        public static vd a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof vd)) ? new a(iBinder) : (vd) queryLocalInterface;
        }

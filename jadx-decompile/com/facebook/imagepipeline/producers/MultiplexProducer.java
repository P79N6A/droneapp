...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    class Multiplexer {
        ...
        public boolean addNewConsumer(com.facebook.imagepipeline.producers.Consumer<T> r7, com.facebook.imagepipeline.producers.ProducerContext r8) {
            /*
            r6 = this;
            r0 = 0;
            r1 = android.util.Pair.create(r7, r8);
            monitor-enter(r6);
            r2 = com.facebook.imagepipeline.producers.MultiplexProducer.this;	 Catch:{ all -> 0x0050 }
            r3 = r6.mKey;	 Catch:{ all -> 0x0050 }
            r2 = r2.getExistingMultiplexer(r3);	 Catch:{ all -> 0x0050 }
        ...
        L_0x0011:
            return r0;
        L_0x0012:
            r0 = r6.mConsumerContextPairs;	 Catch:{ all -> 0x0050 }
            r0.add(r1);	 Catch:{ all -> 0x0050 }
            r2 = r6.updateIsPrefetch();	 Catch:{ all -> 0x0050 }
            r3 = r6.updatePriority();	 Catch:{ all -> 0x0050 }
            r4 = r6.updateIsIntermediateResultExpected();	 Catch:{ all -> 0x0050 }
            r0 = r6.mLastIntermediateResult;	 Catch:{ all -> 0x0050 }
            r5 = r6.mLastProgress;	 Catch:{ all -> 0x0050 }
            monitor-exit(r6);	 Catch:{ all -> 0x0050 }
            ...
            r2 = r6.mLastIntermediateResult;	 Catch:{ all -> 0x005c }
        ...
        L_0x0040:
            r7.onProgressUpdate(r5);	 Catch:{ all -> 0x005f }
        L_0x0043:
            r2 = 0;
            r7.onNewResult(r0, r2);	 Catch:{ all -> 0x005f }
            r6.closeSafely(r0);	 Catch:{ all -> 0x005f }
        L_0x004a:
            monitor-exit(r1);	 Catch:{ all -> 0x005f }
            r6.addCallbacks(r1, r8);
            r0 = 1;
            goto L_0x0011;
        L_0x0050:
            r0 = move-exception;
        ...
        L_0x0055:
            r2 = com.facebook.imagepipeline.producers.MultiplexProducer.this;	 Catch:{ all -> 0x005c }
            r0 = r2.cloneOrNull(r0);	 Catch:{ all -> 0x005c }
            goto L_0x0038;
        L_0x005c:
            r0 = move-exception;
            monitor-exit(r6);	 Catch:{ all -> 0x005c }
        ...
        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void onNextResult(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r4, T r5, boolean r6) {
            /*
            r3 = this;
            monitor-enter(r3);
            r0 = r3.mForwardingConsumer;	 Catch:{ all -> 0x0047 }
            if (r0 == r4) goto L_0x0007;
        L_0x0005:
        ...
        L_0x0006:
            return;
        L_0x0007:
            r0 = r3.mLastIntermediateResult;	 Catch:{ all -> 0x0047 }
            r3.closeSafely(r0);	 Catch:{ all -> 0x0047 }
            r0 = 0;
            r3.mLastIntermediateResult = r0;	 Catch:{ all -> 0x0047 }
            r0 = r3.mConsumerContextPairs;	 Catch:{ all -> 0x0047 }
            r2 = r0.iterator();	 Catch:{ all -> 0x0047 }
            if (r6 != 0) goto L_0x003a;
        L_0x0017:
            r0 = com.facebook.imagepipeline.producers.MultiplexProducer.this;	 Catch:{ all -> 0x0047 }
            r0 = r0.cloneOrNull(r5);	 Catch:{ all -> 0x0047 }
            r3.mLastIntermediateResult = r0;	 Catch:{ all -> 0x0047 }
        L_0x001f:
            monitor-exit(r3);	 Catch:{ all -> 0x0047 }
        L_0x0020:
        ...
        L_0x0026:
            ...
            r0 = (com.facebook.imagepipeline.producers.Consumer) r0;	 Catch:{ all -> 0x0037 }
            r0.onNewResult(r5, r6);	 Catch:{ all -> 0x0037 }
        ...
        L_0x003a:
            ...
            r0 = com.facebook.imagepipeline.producers.MultiplexProducer.this;	 Catch:{ all -> 0x0047 }
            r1 = r3.mKey;	 Catch:{ all -> 0x0047 }
            r0.removeMultiplexer(r1, r3);	 Catch:{ all -> 0x0047 }
            goto L_0x001f;
        L_0x0047:
            r0 = move-exception;
            monitor-exit(r3);	 Catch:{ all -> 0x0047 }

  ...
  extends cn.sharesdk.framework.b
{
  ...
  public HashMap<String, Object> a(String paramString, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      while (i < localArrayList3.size())
      {
        ...
        {
          d.a().d(localStringBuilder.toString(), new Object[0]);
        }
      }
  ...
  public cn.sharesdk.framework.authorize.b getAuthorizeWebviewClient(e parame)
  {
    return new a(parame);
  }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/twitter/b.class

...
public class ap implements Serializable, Cloneable, org.a.b.a<ap, a> {
    ...
    private static final org.a.b.b.b t = new org.a.b.b.b("topic", (byte) 11, (short) 8);
    private static final org.a.b.b.b u = new org.a.b.b.b(com.xiaomi.market.sdk.j.W, (byte) 11, (short) 9);
    private static final org.a.b.b.b v = new org.a.b.b.b("category", (byte) 11, (short) 10);
    public String a;
    public u b;
    public String c;
    public String d;
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, ao.class)));
    ...
    public int b(ap apVar) {
        ...
        if (a()) {
            compareTo = org.a.b.b.a(this.a, apVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (b()) {
            compareTo = org.a.b.b.a(this.b, apVar.b);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (c()) {
            compareTo = org.a.b.b.a(this.c, apVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.a.b.b.a(this.d, apVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.a.b.b.a(this.e, apVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (f()) {
            compareTo = org.a.b.b.a(this.f, apVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.a.b.b.a(this.g, apVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (i()) {
            compareTo = org.a.b.b.a(this.h, apVar.h);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (j()) {
            compareTo = org.a.b.b.a(this.i, apVar.i);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (l()) {
            compareTo = org.a.b.b.a(this.j, apVar.j);
            if (compareTo != 0) {
                return compareTo;
            }
        }

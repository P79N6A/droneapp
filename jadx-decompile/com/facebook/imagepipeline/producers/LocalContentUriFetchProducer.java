...
public class LocalContentUriFetchProducer extends LocalFetchProducer {
    ...
    private static final String[] PROJECTION = new String[]{k._ID, "_data"};
    ...
    private EncodedImage getCameraImage(Uri uri, ResizeOptions resizeOptions) {
        ...
        try {
            ...
            if (resizeOptions != null) {
                EncodedImage thumbnail = getThumbnail(resizeOptions, query.getInt(query.getColumnIndex(k._ID)));
                if (thumbnail != null) {
    ...
    private static int getThumbnailKind(ResizeOptions resizeOptions) {
        return isThumbnailBigEnough(resizeOptions, MICRO_THUMBNAIL_DIMENSIONS) ? 3 : isThumbnailBigEnough(resizeOptions, MINI_THUMBNAIL_DIMENSIONS) ? 1 : 0;
    }

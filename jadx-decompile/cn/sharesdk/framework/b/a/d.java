...
public class d {
        ...
        synchronized (d.class) {
            if (str != null) {
                if (str.trim() != "") {
                    ...
                    a = a2.a(RMsgInfoDB.TABLE, contentValues);
                }
            }
            a = -1;
        }
    ...
    public static synchronized long a(Context context, ArrayList<String> arrayList) {
        ...
        synchronized (d.class) {
            if (arrayList == null) {
                ...
                cn.sharesdk.framework.utils.d.a().i("delete COUNT == %s", Integer.valueOf(b.a(context).a(RMsgInfoDB.TABLE, "_id in ( " + stringBuilder.toString().substring(0, stringBuilder.length() - 1) + " )", null)));
                j = (long) b.a(context).a(RMsgInfoDB.TABLE, "_id in ( " + stringBuilder.toString().substring(0, stringBuilder.length() - 1) + " )", null);
            }
        }
        return j;
    }
    ...
    public static synchronized ArrayList<c> a(Context context) {
        ArrayList<c> a;
        synchronized (d.class) {
            a = b.a(context).a(RMsgInfoDB.TABLE) > 0 ? a(context, null, null) : new ArrayList();
        }
        return a;
    }
    ...
    private static synchronized ArrayList<c> a(Context context, String str, String[] strArr) {
        ...
        synchronized (d.class) {
            ...
            c cVar = new c();
            StringBuilder stringBuilder = new StringBuilder();
            Cursor a = b.a(context).a(RMsgInfoDB.TABLE, new String[]{k._ID, "post_time", "message_data"}, str, strArr, null);

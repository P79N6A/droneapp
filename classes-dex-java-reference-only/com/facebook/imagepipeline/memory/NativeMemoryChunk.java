  ...
  implements Closeable
{
  ...
  public void copy(int paramInt1, NativeMemoryChunk paramNativeMemoryChunk, int paramInt2, int paramInt3)
  {
    ...
    //   22: dup
    //   23: invokespecial 95	java/lang/StringBuilder:<init>	()V
    //   26: ldc 97
    //   28: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: aload_0
    //   32: invokestatic 107	java/lang/System:identityHashCode	(Ljava/lang/Object;)I
    //   35: invokestatic 113	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    ...
    //   46: aload_2
    //   47: invokestatic 107	java/lang/System:identityHashCode	(Ljava/lang/Object;)I
    //   50: invokestatic 113	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   53: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   56: ldc 117
    //   58: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: aload_0
    //   62: getfield 36	com/facebook/imagepipeline/memory/NativeMemoryChunk:mNativePtr	J
    //   65: invokestatic 122	java/lang/Long:toHexString	(J)Ljava/lang/String;
    //   68: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   71: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   74: invokestatic 132	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: pop
    //   78: iconst_0
    //   79: invokestatic 46	com/facebook/common/internal/Preconditions:checkArgument	(Z)V
    //   82: aload_2
    //   83: getfield 36	com/facebook/imagepipeline/memory/NativeMemoryChunk:mNativePtr	J
    //   86: aload_0
    //   87: getfield 36	com/facebook/imagepipeline/memory/NativeMemoryChunk:mNativePtr	J
    //   90: lcmp
    //   91: ifge +35 -> 126
    //   94: aload_2
    //   95: monitorenter
    ...
    //   101: iload_3
    //   102: iload 4
    //   104: invokespecial 134	com/facebook/imagepipeline/memory/NativeMemoryChunk:doCopy	(ILcom/facebook/imagepipeline/memory/NativeMemoryChunk;II)V
    //   107: aload_0
    //   108: monitorexit
    //   109: aload_2
    //   110: monitorexit
    ...
    //   133: iload_3
    //   134: iload 4
    //   136: invokespecial 134	com/facebook/imagepipeline/memory/NativeMemoryChunk:doCopy	(ILcom/facebook/imagepipeline/memory/NativeMemoryChunk;II)V
    //   139: aload_2
    //   140: monitorexit
    //   141: aload_0
    //   142: monitorexit
  ...
  public byte read(int paramInt)
  {
    ...
    //   13: istore_3
    //   14: iload_3
    //   15: invokestatic 71	com/facebook/common/internal/Preconditions:checkState	(Z)V
    //   18: iload_1
    //   19: iflt +44 -> 63
    //   22: iconst_1
    //   23: istore_3
    //   24: iload_3
    //   25: invokestatic 46	com/facebook/common/internal/Preconditions:checkArgument	(Z)V
    //   28: iload_1
    //   29: aload_0
    //   30: getfield 34	com/facebook/imagepipeline/memory/NativeMemoryChunk:mSize	I
    //   33: if_icmpge +35 -> 68
    //   36: iload 4
    //   38: istore_3
    //   39: iload_3
    //   40: invokestatic 46	com/facebook/common/internal/Preconditions:checkArgument	(Z)V
    //   43: aload_0
    //   44: getfield 36	com/facebook/imagepipeline/memory/NativeMemoryChunk:mNativePtr	J
    //   47: iload_1
    //   48: i2l
    //   49: ladd
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/memory/NativeMemoryChunk.class

...
public class ProducerSequenceFactory
{
  ...
  private Producer<Void> getNetworkFetchToEncodedMemoryPrefetchSequence()
  {
    try
    {
      ...
      {
        localObject1 = this.mProducerFactory;
      ...
      Object localObject1 = this.mNetworkFetchToEncodedMemoryPrefetchSequence;
      return (Producer<Void>)localObject1;
    }
    finally {}
  }
  ...
  {
    Object localObject = this.mProducerFactory;
    localObject = ProducerFactory.newAddImageTransformMetaDataProducer(paramProducer);
    ...
    localObject = this.mProducerFactory;
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/core/ProducerSequenceFactory.class

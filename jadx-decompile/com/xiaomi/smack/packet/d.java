...
public abstract class d {
    ...
    private static String d = (com.xiaomi.smack.util.d.a(5) + Constants.ACCEPT_TIME_SEPARATOR_SERVER);
    ...
    protected synchronized String s() {
        ...
        if (!(this.m == null || this.m.isEmpty())) {
            ...
            for (String str : r()) {
                ...
                stringBuilder.append("<name>").append(com.xiaomi.smack.util.d.a(str)).append("</name>");
                ...
                if (q instanceof Integer) {
                    ...
                    stringBuilder.append(com.xiaomi.smack.util.d.a((String) q));
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                stringBuilder.append(com.xiaomi.smack.util.d.a(byteArrayOutputStream.toByteArray())).append("</value>");

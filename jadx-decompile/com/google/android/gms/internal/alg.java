...
public interface alg extends IInterface {
    ...
    public static abstract class a extends Binder implements alg {

        private static class a implements alg {
            private IBinder a;
        ...
        public static alg a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IGoogleFitInternalApi");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alg)) ? new a(iBinder) : (alg) queryLocalInterface;
        }

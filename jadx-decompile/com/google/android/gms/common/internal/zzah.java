...
public final class zzah extends Button {
    ...
    private void c(Resources resources, int i, int i2) {
        setTextColor((ColorStateList) d.a(resources.getColorStateList(a(i2, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))));
        switch (i) {
            case 0:

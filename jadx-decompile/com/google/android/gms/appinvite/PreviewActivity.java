...
public class PreviewActivity extends Activity {
    ...
    private View a(Context context, ViewGroup viewGroup, Bundle bundle) {
        View inflate = LayoutInflater.from(context).inflate(bundle.getInt(b), viewGroup, false);
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(f);
        if (parcelableArrayList != null) {
            Iterator it = parcelableArrayList.iterator();
            while (it.hasNext()) {
                a(inflate, (Bundle) it.next());
            }
        }
        return inflate;
    }
    ...
    private void a(android.view.View r9, android.os.Bundle r10) {
        /*
        r8 = this;
        r3 = 0;
        r4 = -1;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            View a = a(createPackageContext, null, extras);
            if (a == null) {
                finish();
                return;
            }
            ...
            if (!(tabHost == null || tabWidget == null || parcelableArrayList == null)) {
                ...
                while (it.hasNext()) {
                    ...
                    TabSpec newTabSpec = tabHost.newTabSpec(extras.getString(d));
                    newTabSpec.setContent(extras.getInt(e));
                    newTabSpec.setIndicator(a(createPackageContext, tabWidget, extras));

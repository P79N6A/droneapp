...
public class h extends it.a.a.h {
    private String d;
    private int e;
    private String f;
    private String g;
    ...
    private java.net.Socket a(java.lang.String r12, int r13, boolean r14) {
        /*
        r11 = this;
        r2 = 0;
    ...
    L_0x0011:
        r3 = r11.d;	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
        r4 = r11.e;	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
        r4 = r11.b(r3, r4);	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
    L_0x0019:
    ...
    L_0x0027:
        ...
        r2.write(r5);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
    L_0x002f:
        r5 = r11.a(r3);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
    ...
    L_0x0056:
        r3 = r11.d;	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
        r4 = r11.e;	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
        r4 = r11.a(r3, r4);	 Catch:{ IOException -> 0x01a9, all -> 0x01a0 }
        goto L_0x0019;
    L_0x005f:
        r5 = 1;
        r2.write(r5);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
    ...
    L_0x0073:
        ...
        throw r0;	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
    L_0x007b:
        r0 = r11.f;	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
        r5 = "UTF-8";
        r0 = r0.getBytes(r5);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
        r5 = r11.g;	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
        r6 = "UTF-8";
    ...
    L_0x00a1:
        ...
        r2.write(r5);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }
        r0 = r11.a(r3);	 Catch:{ IOException -> 0x003d, all -> 0x0068 }

...
public interface alj extends IInterface {
    ...
    public static abstract class a extends Binder implements alj {

        private static class a implements alj {
            private IBinder a;
        ...
        public static alj a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IGoogleFitSensorsApi");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alj)) ? new a(iBinder) : (alj) queryLocalInterface;
        }

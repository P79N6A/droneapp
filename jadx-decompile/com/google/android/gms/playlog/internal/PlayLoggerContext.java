...
public class PlayLoggerContext extends AbstractSafeParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.a == playLoggerContext.a && this.b.equals(playLoggerContext.b) && this.c == playLoggerContext.c && this.d == playLoggerContext.d && c.a(this.h, playLoggerContext.h) && c.a(this.e, playLoggerContext.e) && c.a(this.f, playLoggerContext.f) && this.g == playLoggerContext.g && this.i == playLoggerContext.i && this.j == playLoggerContext.j;
    }

    public int hashCode() {
        return c.a(new Object[]{Integer.valueOf(this.a), this.b, Integer.valueOf(this.c), Integer.valueOf(this.d), this.h, this.e, this.f, Boolean.valueOf(this.g), Boolean.valueOf(this.i), Integer.valueOf(this.j)});
    }

...
public class r implements Creator<DataDeleteRequest> {
    static void a(DataDeleteRequest dataDeleteRequest, Parcel parcel, int i) {
        int a = b.a(parcel);
        b.a(parcel, 1, dataDeleteRequest.j());
        b.a(parcel, 2, dataDeleteRequest.i());
        b.c(parcel, 3, dataDeleteRequest.a(), false);
        b.c(parcel, 4, dataDeleteRequest.b(), false);
        b.c(parcel, 5, dataDeleteRequest.c(), false);
        b.a(parcel, 6, dataDeleteRequest.g());
        b.a(parcel, 7, dataDeleteRequest.h());
        b.a(parcel, 1000, dataDeleteRequest.f());
        b.a(parcel, 8, dataDeleteRequest.k(), false);
        b.a(parcel, a);
    }

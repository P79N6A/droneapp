...
public class Util {
    ...
    public static Bundle composeHaboCgiReportParams(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        ...
        bundle.putString(com.mi.live.openlivesdk.b.g, Global.getPackageName());
                    ...
                    if (stringArray != null) {
                        for (int i = 0; i < stringArray.length; i++) {
                            if (i == 0) {
                                ...
                                stringBuilder.append(URLEncoder.encode(com.xiaomi.mipush.sdk.Constants.ACCEPT_TIME_SEPARATOR_SP + stringArray[i]));
                            }
                        }
                    }
                    obj3 = obj;
    ...
    public static String getLocation(Context context) {
        ...
        try {
            LocationManager locationManager = (LocationManager) context.getSystemService(com.google.firebase.a.a.b.p);
    ...
    public static Statistic upload(Context context, String str, Bundle bundle) {
        ...
        httpPost.setHeader(org.a.a.e.j, "Keep-Alive");
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();

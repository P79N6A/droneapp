...
public class Profile extends MAutoDBItem {
    ...
    public static String[] columns = new String[]{"username", "bindqq", "bindmobile", "bindemail", RContact.COL_ALIAS, RContact.COL_NICKNAME, "signature", "province", "city", "weibo", "avatar"};

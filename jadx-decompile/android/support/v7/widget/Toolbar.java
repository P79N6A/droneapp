...
public class Toolbar extends ViewGroup {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            i6 = layoutChildRight(this.mNavButtonView, i6, iArr, minimumHeight);
            i5 = paddingLeft;
        } else {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            if (obj != null) {
                i6 = layoutChildRight(this.mCollapseButtonView, i6, iArr, minimumHeight);
            } else {
        ...
        if (shouldLayout(this.mMenuView)) {
            if (obj != null) {
                ...
                i6 = layoutChildRight(this.mMenuView, i6, iArr, minimumHeight);
            }
        }
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            if (obj != null) {
                i6 = layoutChildRight(this.mExpandedActionView, i6, iArr, minimumHeight);
            } else {
        ...
        if (!shouldLayout(this.mLogoView)) {
            ...
            currentContentInsetLeft = layoutChildRight(this.mLogoView, i6, iArr, minimumHeight);
            currentContentInsetRight = i5;
        } else {
            currentContentInsetLeft = i6;
            currentContentInsetRight = layoutChildLeft(this.mLogoView, i5, iArr, minimumHeight);
        }
            ...
            switch (this.mGravity & 112) {
                ...
                default:
                    ...
                    if (paddingTop2 < layoutParams.topMargin + this.mTitleMarginTop) {
                        i6 = layoutParams.topMargin + this.mTitleMarginTop;
                    } else {
                        measuredHeight = (((height - paddingBottom) - measuredHeight) - paddingTop2) - paddingTop;
                        i6 = measuredHeight < layoutParams.bottomMargin + this.mTitleMarginBottom ? Math.max(0, paddingTop2 - ((layoutParams2.bottomMargin + this.mTitleMarginBottom) - measuredHeight)) : paddingTop2;
                    }
                    paddingTop2 = paddingTop + i6;
                    break;
            }
            if (obj != null) {
                i6 = (obj2 != null ? this.mTitleMarginStart : 0) - iArr[1];
                ...
                i6 = (obj2 != null ? this.mTitleMarginStart : 0) - iArr[0];
                ...
                if (shouldLayout) {
                    ...
                    i6 = layoutParams.bottomMargin + measuredWidth;
                ...
                if (shouldLayout2) {
                    ...
                    i6 = layoutParams.bottomMargin + measuredHeight;
                    i6 = this.mTitleMarginEnd + paddingTop2;
                } else {
        ...
        for (measuredWidth = 0; measuredWidth < currentContentInsetRight; measuredWidth++) {
            currentContentInsetLeft = layoutChildRight((View) this.mTempViews.get(measuredWidth), currentContentInsetLeft, iArr, minimumHeight);
        }

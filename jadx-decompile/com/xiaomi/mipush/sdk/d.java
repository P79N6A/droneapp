...
public class d extends a {
    ...
    private boolean c() {
        ...
        int a = ah.a(this.g).a(e.P.a(), 3600);
    ...
    private Location h() {
        ...
        LocationManager locationManager = (LocationManager) this.g.getSystemService(com.google.firebase.a.a.b.p);
        try {
    ...
    public void run() {
        if (!com.xiaomi.channel.commonutils.network.d.e(this.g)) {
            ...
            aeVar.a(a);
            u.a(this.g).a(aeVar, com.xiaomi.xmpush.thrift.a.i, true, null);
            i();

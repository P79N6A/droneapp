...
public class c extends SSDKHandlerThread {
    ...
    private void a(int i, String str, String str2, String[] strArr) {
        try {
            if (this.f.b()) {
                if ("none".equals((String) ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.d}), "getDetailNetworkTypeForStatic", new Object[0]))) {
    ...
    private void b(int i, String str, String str2) {
        ArrayList arrayList = new ArrayList();
        Object invokeStaticMethod = ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.d});
        ...
        try {
            ...
            networkTimeOut.readTimout = 10000;
            networkTimeOut.connectionTimeout = 10000;
            MobLog.getInstance().i("get server config == %s", new Object[]{this.e.httpPost(b(), arrayList, null, null, networkTimeOut)});
            ...
            if (invokeStaticMethod != null && (invokeStaticMethod instanceof HashMap)) {
                ...
                if (fromJson.containsKey("timestamp")) {
                    this.f.a(System.currentTimeMillis() - R.parseLong(String.valueOf(fromJson.get("timestamp"))));
                }

...
public class m
{
  ...
  private void c()
  {
    if ((this.bE == null) || (this.bE.size() == 0))
    {
      ...
      this.bE.put("7", new String[] { "unauthorized;3", "Comm error;3", "tempe error;3", "overcurrent;3", "low battery level;1", "low battery level;0", "critical;0" });
      this.bE.put("8", new String[] { "unattached;3", "full;3", "read error;3", "write error;3", ";", ";", "critical;3" });
      this.bE.put("9", new String[] { "unattached;0", "stall;0", "overheat;0", "overspeed;2", "overcurrent;2", ";", "critical;0" });
      ...
      this.bE.put("32", new String[] { "bad accel;3", "euler error;3", "diverge;2", "Un calied;3", ";3", ";3", "critical;3" });
      this.bE.put("33", new String[] { "close to;2", "entered;3", ";3", ";3", ";3", ";3", "critical;3" });
      this.bE.put("34", new String[] { "Attitute limit;2", "Attitute limit;2", "speed limit;2", ";", ";", ";", ";" });
    }
  }
  
  public String a(int paramInt1, int paramInt2, Context paramContext)
  {
    paramContext = "";
    Object localObject;
    if (paramInt2 == 0) {
    ...
    do
    {
      do
      {
        ...
        arrayOfString = a(String.valueOf(paramInt2));
        localObject = paramContext;
    ...
    for (;;)
    {
      ...
      if ((1 << paramInt2 & paramInt1) > 0) {
        localObject = paramContext + arrayOfString[paramInt2] + "#";
      }
      paramInt2 += 1;
  ...
  {
    return (1 << paramInt2 - 1 & paramInt1) > 0;
  }
  
  public String[] a(String paramString)
  {
    if ((paramString != null) && (!paramString.equals("")) && (this.bE.containsKey(paramString))) {
      return (String[])this.bE.get(paramString);
    }
    return null;
  }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/fimi/soul/utils/m.class

  ...
  implements AbsListView.OnScrollListener
{
  ...
  public UIRefreshEXPView(Context paramContext)
  {
    super(paramContext);
    a(paramContext);
  }
  
  public UIRefreshEXPView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    a(paramContext);
  }
  
  public UIRefreshEXPView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void i()
  {
    ...
    this.w.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        if (UIRefreshEXPView.c(UIRefreshEXPView.this))
        {
          if (!UIRefreshEXPView.d(UIRefreshEXPView.this)) {
            break label59;
          }
          if ((UIRefreshEXPView.e(UIRefreshEXPView.this) != 1) && (UIRefreshEXPView.f(UIRefreshEXPView.this) != 2))
          {
            UIRefreshEXPView.a(UIRefreshEXPView.this, 1);
            UIRefreshEXPView.g(UIRefreshEXPView.this);
          }
        }
        label59:
        while (UIRefreshEXPView.e(UIRefreshEXPView.this) == 1) {
          return;
        }
        UIRefreshEXPView.a(UIRefreshEXPView.this, 1);
        UIRefreshEXPView.g(UIRefreshEXPView.this);
  ...
  public void setCanLoadMore(final boolean paramBoolean)
  {
    ...
    this.w.post(new Runnable()
    {
      ...
      {
        View localView;
        if ((paramBoolean) && (UIRefreshEXPView.this.getFooterViewsCount() == 0))
        {
          UIRefreshEXPView.a(UIRefreshEXPView.this);
          localView = UIRefreshEXPView.b(UIRefreshEXPView.this);
          if (!paramBoolean) {
            break label82;
          }
          i = 0;
        ...
        label82:
        label88:
        for (int i = 0;; i = -UIRefreshEXPView.b(UIRefreshEXPView.this).getHeight())
        {
          localView.setPadding(0, i, 0, 0);
          return;
          UIRefreshEXPView.this.g();
          break;
          i = 8;
          break label41;
        }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/fimi/soul/view/UIRefreshEXPView.class

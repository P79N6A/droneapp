...
public interface vi extends IInterface {
    ...
    public static abstract class a extends Binder implements vi {

        private static class a implements vi {
            private IBinder a;
        ...
        public static vi a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnCustomTemplateAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof vi)) ? new a(iBinder) : (vi) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(com.google.android.gms.internal.vd.a.a(parcel.readStrongBinder()));

...
public interface ami extends IInterface {
    ...
    public static abstract class a extends Binder implements ami {

        private static class a implements ami {
            private IBinder a;
        ...
        public static ami asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ami)) ? new a(iBinder) : (ami) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                case 1:
                    ...
                    init(com.google.android.gms.c.e.a.a(parcel.readStrongBinder()));

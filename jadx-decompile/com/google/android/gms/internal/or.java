...
public final class or {
    ...
    private static final class a implements Serializable, GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && or.a((Type) this, (GenericArrayType) obj);
        }
        ...
        public String toString() {
            return String.valueOf(or.f(this.a)).concat("[]");
        }
    }
    ...
    private static final class b implements Serializable, ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.a = type == null ? null : or.d(type);
            this.b = or.d(type2);
            this.c = (Type[]) typeArr.clone();
            while (i < this.c.length) {
                op.a(this.c[i]);
                or.i(this.c[i]);
                this.c[i] = or.d(this.c[i]);
                i++;
            }
        }

        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && or.a((Type) this, (ParameterizedType) obj);
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.c) ^ this.b.hashCode()) ^ or.b(this.a);
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder((this.c.length + 1) * 30);
            stringBuilder.append(or.f(this.b));
            if (this.c.length == 0) {
                return stringBuilder.toString();
            }
            stringBuilder.append("<").append(or.f(this.c[0]));
            for (int i = 1; i < this.c.length; i++) {
                stringBuilder.append(", ").append(or.f(this.c[i]));
            }
    ...
    private static final class c implements Serializable, WildcardType {
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            op.a(typeArr2.length <= 1);
            op.a(typeArr.length == 1);
            ...
            or.i(typeArr[0]);
            this.b = null;
            this.a = or.d(typeArr[0]);
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && or.a((Type) this, (WildcardType) obj);
        }
        ...
        public String toString() {
            ...
            if (this.b != null) {
                str = "? super ";
                valueOf = String.valueOf(or.f(this.b));
                return valueOf.length() != 0 ? str.concat(valueOf) : new String(str);
            } else if (this.a == Object.class) {
                return "?";
            } else {
                str = "? extends ";
                valueOf = String.valueOf(or.f(this.a));
                return valueOf.length() != 0 ? str.concat(valueOf) : new String(str);
            }
        }
    }
    ...
    public static Type a(Type type, Class<?> cls, Type type2) {
        ...
        if ((type3 instanceof Class) && ((Class) type3).isArray()) {
            ...
            return i2 != 0 ? a(a2, parameterizedType.getRawType(), r1) : parameterizedType;
            ...
            if (r1.length == 1) {
                ...
                return a != r1[0] ? c(a) : wildcardType;
            } else if (r4.length != 1) {
                return wildcardType;
            } else {
                componentType = a(type, (Class) cls, r4[0]);
                return componentType != r4[0] ? b(componentType) : wildcardType;
            }
        }
    }
    ...
    static Type b(Type type, Class<?> cls, Class<?> cls2) {
        op.a(cls2.isAssignableFrom(cls));

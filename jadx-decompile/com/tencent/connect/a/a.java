...
public class a {
    ...
    public static void c(Context context, QQToken qQToken) {
        ...
        try {
            ...
            b.getMethod("startStatService", new Class[0]).invoke(b, new Object[]{context, str, Integer.valueOf(Class.forName("com.tencent.stat.common.StatConstants").getField(b.e).getInt(null))});
            g = true;
        } catch (Exception e) {
            e.printStackTrace();
        }

    ...
    new Appendable()
    {
      ...
      public Appendable append(char paramAnonymousChar)
      {
        if (this.a != -1)
        {
          ...
          arrayOfChar = e.this.a(Character.toCodePoint((char)this.a, paramAnonymousChar));
          if (arrayOfChar != null) {
        ...
        char[] arrayOfChar = e.this.a(paramAnonymousChar);
        if (arrayOfChar != null)
        {
          a(arrayOfChar, arrayOfChar.length);
          return this;
      ...
      public Appendable append(CharSequence paramAnonymousCharSequence, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        if (paramAnonymousInt1 < paramAnonymousInt2)
        {
          ...
          arrayOfChar = e.this.a(Character.toCodePoint((char)this.a, c1));
          if (arrayOfChar == null) {
            break label146;
          }
          a(arrayOfChar, arrayOfChar.length);
        ...
        for (;;)
        {
          i = e.this.a(paramAnonymousCharSequence, i, paramAnonymousInt2);
          ...
          paramAnonymousInt1 = e.b(paramAnonymousCharSequence, i, paramAnonymousInt2);
          if (paramAnonymousInt1 < 0)
          {
            this.a = (-paramAnonymousInt1);
            return this;
          }
          arrayOfChar = e.this.a(paramAnonymousInt1);
          if (arrayOfChar != null)
          {
            a(arrayOfChar, arrayOfChar.length);
            label208:
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/framework/utils/e.class

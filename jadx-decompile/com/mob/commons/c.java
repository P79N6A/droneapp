...
public class c implements Callback {
    ...
    private c(Context context) {
        ...
        this.d.addField(a.i, "text", true);
        this.d.addField(UriUtil.DATA_SCHEME, "text", true);
    ...
    private void a() {
        Object obj;
        try {
            obj = (String) ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.b}), "getNetworkType", new Object[0]);
        } catch (Throwable th) {
    ...
    private boolean a(ArrayList<String[]> arrayList) {
        try {
            ...
            Object invokeStaticMethod = ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.b});
            ...
            arrayList2.add(new KVPair(b.f, ((MobProduct) a2.get(0)).getProductAppkey()));
    ...
    private ArrayList<String[]> b() {
        ...
        try {
            Cursor query = SQLiteHelper.query(this.d, new String[]{a.i, UriUtil.DATA_SCHEME}, null, null, null);
            if (query != null) {
        ...
        e.a(new File(R.getCacheRoot(this.b), "comm/locks/.dhlock"), true, new Runnable(this) {
            ...
            public void run() {
                try {
                    ...
                    contentValues.put(a.i, String.valueOf(j));
                    contentValues.put(UriUtil.DATA_SCHEME, Base64.encodeToString(Data.AES128Encode(Data.rawMD5(String.valueOf(ReflectHelper.invokeInstanceMethod(ReflectHelper.invokeStaticMethod("DeviceHelper", "getInstance", new Object[]{this.c.b}), "getManufacturer", new Object[0]))), this.c.e.fromHashMap(hashMap).getBytes("utf-8")), 2));
    ...
    public boolean handleMessage(Message message) {
        switch (message.what) {
            case 1:
                a();
                this.c.sendEmptyMessageDelayed(1, NotificationOptions.a);
                break;
            case 2:

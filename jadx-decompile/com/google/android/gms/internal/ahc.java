...
public interface ahc extends IInterface {
    ...
    public static abstract class a extends Binder implements ahc {
        ...
        public static ahc a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ahc)) ? new a(iBinder) : (ahc) queryLocalInterface;
        }

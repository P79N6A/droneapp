...
public interface akw extends IInterface {
    ...
    public static abstract class a extends Binder implements akw {

        private static class a implements akw {
            private IBinder a;
        ...
        public static akw a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof akw)) ? new a(iBinder) : (akw) queryLocalInterface;
        }

...
public interface ael extends IInterface {
    ...
    public static abstract class a extends Binder implements ael {

        private static class a implements ael {
            private IBinder a;
        ...
        public static ael a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ael)) ? new a(iBinder) : (ael) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.appinvite.internal.IAppInviteCallbacks");
                    a(parcel.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void a(Status status, Intent intent);
}

  ...
  implements DialogInterface.OnCancelListener
{
  ...
  private void a()
  {
    ...
    b.a().b(this, ((Integer)localObject).intValue(), 2, this);
    this.a = 1;
  }
  
  private void a(int paramInt, aic paramaic)
  {
    switch (paramInt)
    {
    default: 
      return;
    case 0: 
      paramaic.b(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
      return;
    }
    paramaic.b();
  }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/google/android/gms/common/api/GoogleApiActivity.class

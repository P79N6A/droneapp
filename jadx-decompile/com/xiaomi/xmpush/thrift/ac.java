...
public class ac implements Serializable, Cloneable, org.a.b.a<ac, a> {
    public static final Map<a, b> b;
    private static final j c = new j("XmPushActionCustomConfig");
    private static final org.a.b.b.b d = new org.a.b.b.b("customConfigs", (byte) 15, (short) 1);
    public List<p> a;
    ...
    static {
        ...
        enumMap.put(a.CUSTOM_CONFIGS, new b("customConfigs", (byte) 1, new d((byte) 15, new g((byte) 12, p.class))));
    ...
    public int b(ac acVar) {
        ...
        if (b()) {
            compareTo = org.a.b.b.a(this.a, acVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }

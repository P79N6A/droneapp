...
public class f implements Creator<SessionReadRequest> {
    static void a(SessionReadRequest sessionReadRequest, Parcel parcel, int i) {
        ...
        b.a(parcel, 3, sessionReadRequest.i());
        b.a(parcel, 4, sessionReadRequest.h());
        b.c(parcel, 5, sessionReadRequest.c(), false);
        b.c(parcel, 6, sessionReadRequest.d(), false);
        b.a(parcel, 7, sessionReadRequest.j());
        b.a(parcel, 1000, sessionReadRequest.l());
        b.a(parcel, 8, sessionReadRequest.g());
        b.b(parcel, 9, sessionReadRequest.f(), false);
        b.a(parcel, 10, sessionReadRequest.k(), false);
        b.a(parcel, a);
    }

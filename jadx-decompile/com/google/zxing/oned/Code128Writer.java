...
public final class Code128Writer extends UPCEANWriter {
    ...
    public byte[] encode(String str) {
        ...
        i2 = UPCEANWriter.appendPattern(bArr, 0, Code128Reader.CODE_PATTERNS[104], 1);
        i3 = 104;
        while (i < length) {
        ...
        i3 = UPCEANWriter.appendPattern(bArr, i2, Code128Reader.CODE_PATTERNS[i3 % 103], 1) + i2;
        i3 += UPCEANWriter.appendPattern(bArr, i3, Code128Reader.CODE_PATTERNS[106], 1);
        return bArr;
    }
}

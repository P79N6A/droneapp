  ...
  public TtsError a(h paramh)
  {
    ...
    if (paramh != null)
    {
      ...
      while (this.f.hasNext())
      {
        ...
        i = 0;
        int j = ((com.baidu.tts.i.a.a)localObject2).a();
        int k = ((com.baidu.tts.i.a.a)localObject2).b();
        while ((i < k) && (this.d.getPlayState() != 1))
        {
          LoggerProxy.d("AudioTrackPlayer", "before write");
          int m = this.d.write(arrayOfByte, i + j, k - i);
          LoggerProxy.d("AudioTrackPlayer", "writtenbytes=" + m + "--offset=" + i + "--dataLength=" + k);
          while (this.g) {
            try
            {
              this.b.lock();
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/baidu/tts/b/b/b/b.class

...
public interface g extends IInterface {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(parcel.readInt() != 0 ? (DataHolder) DataHolder.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (ParcelableEventList) ParcelableEventList.CREATOR.createFromParcel(parcel) : null);
    ...
    void a(DataHolder dataHolder, ParcelableEventList parcelableEventList);
}

...
public class TaskGuide extends BaseApi {
        ...
        protected void a(final Exception exception) {
            ...
            if (this.c.g != null) {
                this.c.g.post(new Runnable(this) {
                    ...
                    public void run() {
                        k kVar = k.INIT;
                        if ((this.b.b == 0 ? this.b.c.i : this.b.c.j) == k.WAITTING_BACK_REWARD) {
    ...
    private class i extends LinearLayout {
        ...
        private void a() {
            ...
            this.b.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(242, it.a.a.e.v, 199));
            this.b.setGravity(3);
            ...
            this.c.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(242, it.a.a.e.v, 199));
    ...
    private k c(int i) {
        return i == 0 ? this.i : i == 1 ? this.j : k.INIT;
    }

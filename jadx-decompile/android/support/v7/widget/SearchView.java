...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            return (screenWidthDp < 960 || screenHeightDp < a.e || configuration.orientation != 2) ? (screenWidthDp >= 600 || (screenWidthDp >= 640 && screenHeightDp >= 480)) ? 192 : 160 : 256;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mVoiceWebSearchIntent.addFlags(e.a_);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(e.a_);

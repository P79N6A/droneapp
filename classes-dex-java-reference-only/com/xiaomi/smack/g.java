...
public final class g
{
  ...
  static
  {
    // Byte code:
    //   0: sipush 5000
    //   3: putstatic 18	com/xiaomi/smack/g:a	I
    //   6: ldc 19
    //   8: putstatic 21	com/xiaomi/smack/g:b	I
    //   11: ldc 22
    //   13: putstatic 24	com/xiaomi/smack/g:c	I
    //   16: ldc 19
    //   18: putstatic 26	com/xiaomi/smack/g:d	I
    //   21: new 28	java/util/Vector
    //   24: dup
    //   25: invokespecial 31	java/util/Vector:<init>	()V
    //   28: putstatic 33	com/xiaomi/smack/g:e	Ljava/util/Vector;
    //   31: invokestatic 36	com/xiaomi/smack/g:d	()[Ljava/lang/ClassLoader;
    //   34: astore 7
    //   36: aload 7
    //   38: arraylength
    //   39: istore_3
    ...
    //   50: aaload
    //   51: ldc 38
    //   53: invokevirtual 44	java/lang/ClassLoader:getResources	(Ljava/lang/String;)Ljava/util/Enumeration;
    //   56: astore 8
    //   58: aload 8
    ...
    //   84: astore 4
    //   86: aload 6
    //   88: invokevirtual 60	java/net/URL:openStream	()Ljava/io/InputStream;
    //   91: astore 6
    //   93: aload 6
    //   95: astore 4
    //   97: aload 6
    //   99: astore 5
    //   101: invokestatic 66	org/xmlpull/v1/XmlPullParserFactory:newInstance	()Lorg/xmlpull/v1/XmlPullParserFactory;
    //   104: invokevirtual 70	org/xmlpull/v1/XmlPullParserFactory:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   107: astore 9
    //   109: aload 6
    //   111: astore 4
    //   113: aload 6
    ...
    //   196: astore 5
    //   198: aload 9
    //   200: invokestatic 103	com/xiaomi/smack/g:a	(Lorg/xmlpull/v1/XmlPullParser;)V
    //   203: aload 6
    //   205: astore 4
    //   207: aload 6
    //   209: astore 5
    ...
    //   226: aload 6
    //   228: invokevirtual 111	java/io/InputStream:close	()V
    //   231: goto -173 -> 58
    //   234: astore 4
    //   236: goto -178 -> 58
    //   239: aload 6
    ...
    //   254: ldc 113
    //   256: invokevirtual 100	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   259: ifeq +49 -> 308
    //   262: aload 6
    //   264: astore 4
    //   266: aload 6
    //   268: astore 5
    //   270: aload 9
    //   272: getstatic 18	com/xiaomi/smack/g:a	I
    //   275: invokestatic 116	com/xiaomi/smack/g:a	(Lorg/xmlpull/v1/XmlPullParser;I)I
    //   278: putstatic 18	com/xiaomi/smack/g:a	I
    //   281: goto -78 -> 203
    //   284: astore 6
    //   286: aload 4
    //   288: astore 5
    //   290: aload 6
    //   292: invokevirtual 119	java/lang/Exception:printStackTrace	()V
    //   295: aload 4
    //   297: invokevirtual 111	java/io/InputStream:close	()V
    //   300: goto -242 -> 58
    //   303: astore 4
    //   305: goto -247 -> 58
    //   308: aload 6
    ...
    //   314: astore 5
    //   316: aload 9
    //   318: invokeinterface 92 1 0
    //   323: ldc 121
    //   325: invokevirtual 100	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   328: ifeq +43 -> 371
    //   331: aload 6
    //   333: astore 4
    //   335: aload 6
    //   337: astore 5
    //   339: aload 9
    //   341: getstatic 21	com/xiaomi/smack/g:b	I
    //   344: invokestatic 116	com/xiaomi/smack/g:a	(Lorg/xmlpull/v1/XmlPullParser;I)I
    //   347: putstatic 21	com/xiaomi/smack/g:b	I
    //   350: goto -147 -> 203
    //   353: astore 4
    //   355: aload 5
    //   357: invokevirtual 111	java/io/InputStream:close	()V
    //   360: aload 4
    //   362: athrow
    //   363: astore 4
    //   365: aload 4
    //   367: invokevirtual 119	java/lang/Exception:printStackTrace	()V
    //   370: return
    //   371: aload 6
    //   373: astore 4
    //   375: aload 6
    //   377: astore 5
    //   379: aload 9
    //   381: invokeinterface 92 1 0
    //   386: ldc 123
    //   388: invokevirtual 100	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   391: ifeq -188 -> 203
    //   394: aload 6
    //   396: astore 4
    //   398: aload 6
    //   400: astore 5
    //   402: getstatic 33	com/xiaomi/smack/g:e	Ljava/util/Vector;
    //   405: aload 9
    //   407: invokeinterface 126 1 0
    //   412: invokevirtual 129	java/util/Vector:add	(Ljava/lang/Object;)Z
    //   415: pop
    //   416: goto -213 -> 203
    //   419: iload_0
    //   420: iconst_1
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/xiaomi/smack/g.class

...
public class Albums extends BaseApi {
    ...
    public void addAlbum(String str, String str2, AlbumSecurity albumSecurity, String str3, String str4, IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.mToken, Global.getContext(), "photo/add_album", composeCGIParams, "POST", new BaseApi$TempRequestListener(this, iUiListener));
    }

    public void listAlbum(IUiListener iUiListener) {
        HttpUtils.requestAsync(this.mToken, Global.getContext(), "photo/list_album", composeCGIParams(), "GET", new BaseApi$TempRequestListener(this, iUiListener));
    }
    ...
    public void listPhotos(String str, IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.mToken, Global.getContext(), "photo/list_photo", composeCGIParams, "GET", new BaseApi$TempRequestListener(this, iUiListener));
    }
    ...
    public void uploadPicture(String str, String str2, String str3, String str4, String str5, IUiListener iUiListener) {
        ...
        try {
            ...
            try {
                ...
                HttpUtils.requestAsync(this.mToken, Global.getContext(), "photo/upload_pic", composeCGIParams, "POST", baseApi$TempRequestListener);

...
public class n
{
  ...
  public ak.b a(ak.b paramb, Context paramContext, b paramb1, String paramString)
  {
    ...
    paramb.f = String.format("%1$s:%2$s,%3$s:%4$s,%5$s:%6$s:%7$s:%8$s", new Object[] { "sdk_ver", Integer.valueOf(26), "cpvn", "3_2_1", "cpvc", Integer.valueOf(30201), "aapn", str });
    if (b(paramContext)) {}
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/xiaomi/push/service/n.class

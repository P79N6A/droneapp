...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector {
    ...
    public String findDeserializablePropertyName(AnnotatedField annotatedField) {
        ...
        return jsonProperty != null ? jsonProperty.value() : (annotatedField.hasAnnotation(JsonDeserialize.class) || annotatedField.hasAnnotation(JsonView.class)) ? "" : null;
    }
    ...
    public String findGettablePropertyName(AnnotatedMethod annotatedMethod) {
        ...
        return jsonGetter != null ? jsonGetter.value() : (annotatedMethod.hasAnnotation(JsonSerialize.class) || annotatedMethod.hasAnnotation(JsonView.class)) ? "" : null;
    }
    ...
    public AnnotationIntrospector$ReferenceProperty findReferenceType(AnnotatedMember annotatedMember) {
        ...
        return jsonBackReference != null ? AnnotationIntrospector$ReferenceProperty.back(jsonBackReference.value()) : null;
    }
    ...
    public String findSerializablePropertyName(AnnotatedField annotatedField) {
        JsonProperty jsonProperty = (JsonProperty) annotatedField.getAnnotation(JsonProperty.class);
        return jsonProperty != null ? jsonProperty.value() : (annotatedField.hasAnnotation(JsonSerialize.class) || annotatedField.hasAnnotation(JsonView.class)) ? "" : null;
    }
    ...
    public String findSettablePropertyName(AnnotatedMethod annotatedMethod) {
        ...
        return jsonSetter != null ? jsonSetter.value() : (annotatedMethod.hasAnnotation(JsonDeserialize.class) || annotatedMethod.hasAnnotation(JsonView.class)) ? "" : null;
    }

...
public class b {
    ...
    public static a d(Context context, String str) {
        ...
        try {
            if (((Integer) a.a(AppOpsManager.class, "OP_POST_NOTIFICATION")) == null) {
                return a.a;
            }
            ApplicationInfo applicationInfo = context.getPackageManager().getApplicationInfo(str, 0);
            Integer num = (Integer) a.a((AppOpsManager) context.getSystemService("appops"), "checkOpNoThrow", new Object[]{num, Integer.valueOf(applicationInfo.uid), str});

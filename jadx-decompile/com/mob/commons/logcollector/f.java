...
public class f {
    public static synchronized long a(Context context, long j, String str, int i, String str2) {
        long j2;
    ...
    public static synchronized long a(Context context, ArrayList<String> arrayList) {
        ...
        synchronized (f.class) {
            if (arrayList == null) {
                ...
                MobLog.getInstance().i("delete COUNT == %s", new Object[]{Integer.valueOf(b.a(context).a("table_exception", "exception_md5 in ( " + stringBuilder.toString().substring(0, stringBuilder.length() - 1) + " )", null))});
    ...
    private static synchronized ArrayList<e> a(Context context, String str, String[] strArr) {
    ...
    public static synchronized ArrayList<e> a(Context context, String[] strArr) {
        ArrayList<e> a;
        synchronized (f.class) {
            ...
            a = b.a(context).a("table_exception") > 0 ? a(context, str, strArr) : new ArrayList();
        }
        return a;
    }
}

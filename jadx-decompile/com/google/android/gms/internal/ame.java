...
public class ame {
    ...
    private static int a(byte[] r6, int r7, int r8, int r9) {
        /*
    ...
    L_0x006b:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ame.a(byte[], int, int, int):int");
    }
    ...
    public static String a(String str, String str2) {
        ...
        return Integer.toHexString(a(obj, 0, obj.length, 0));
    }

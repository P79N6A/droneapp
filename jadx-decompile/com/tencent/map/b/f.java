...
public final class f implements com.tencent.map.b.b.a, com.tencent.map.b.d.c, com.tencent.map.b.e.c, com.tencent.map.b.g.c {
    ...
    private static ArrayList<com.tencent.map.a.a.c> a(JSONArray jSONArray) {
        int length = jSONArray.length();
        ArrayList<com.tencent.map.a.a.c> arrayList = new ArrayList();
        for (int i = 0; i < length; i++) {
            JSONObject jSONObject = jSONArray.getJSONObject(i);
            arrayList.add(new com.tencent.map.a.a.c(jSONObject.getString(User.FN_NAME), jSONObject.getString("addr"), jSONObject.getString("catalog"), jSONObject.getDouble("dist"), Double.parseDouble(jSONObject.getString("latitude")), Double.parseDouble(jSONObject.getString("longitude"))));
        }
        return arrayList;
    }
    ...
    private void a(String str) {
        ...
        try {
            ...
            JSONObject jSONObject2 = jSONObject.getJSONObject(com.google.firebase.a.a.b.p);
            this.z.a = 1;
            ...
            if ((this.l == 3 || this.l == 4) && this.m == 1) {
                ...
                this.z.a(jSONObject2.getString(User.FN_NAME));
            ...
            if (this.l == 7 && this.m == 1) {
                ...
                if (i == 0) {
                    ...
                    this.z.v = jSONObject2.getString(as.a);
                }
                this.z.h = i;
                this.z.z = 7;
            }

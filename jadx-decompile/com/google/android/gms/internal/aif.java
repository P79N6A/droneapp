...
public interface aif extends IInterface {
    ...
    public static abstract class a extends Binder implements aif {

        private static class a implements aif {
            private IBinder a;
        ...
        public static aif a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.api.internal.IStatusCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof aif)) ? new a(iBinder) : (aif) queryLocalInterface;
        }

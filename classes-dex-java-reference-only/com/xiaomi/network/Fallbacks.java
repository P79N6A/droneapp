...
class Fallbacks
{
  ...
  public void addFallback(Fallback paramFallback)
  {
    ...
    //   26: aload_1
    //   27: invokevirtual 50	com/xiaomi/network/Fallback:a	(Lcom/xiaomi/network/Fallback;)Z
    //   30: ifeq +36 -> 66
    //   33: aload_0
  ...
  public Fallbacks fromJSON(JSONObject paramJSONObject)
  {
    try
    {
      ...
      {
        this.mFallbacks.add(new Fallback(this.host).a(paramJSONObject.getJSONObject(i)));
        i += 1;
      }
      return this;
    }
  ...
  public Fallback getFallback()
  {
    ...
    //   27: astore_2
    //   28: aload_2
    //   29: invokevirtual 91	com/xiaomi/network/Fallback:a	()Z
    //   32: ifeq +17 -> 49
    //   35: invokestatic 97	com/xiaomi/network/HostManager:getInstance	()Lcom/xiaomi/network/HostManager;
    //   38: aload_2
    //   39: invokevirtual 101	com/xiaomi/network/Fallback:e	()Ljava/lang/String;
    //   42: invokevirtual 104	com/xiaomi/network/HostManager:setCurrentISP	(Ljava/lang/String;)V
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_2
    //   48: areturn
  ...
  public void purge(boolean paramBoolean)
  {
    for (;;)
    {
      ...
      try
      {
        i = this.mFallbacks.size() - 1;
        if (i >= 0)
        {
          Fallback localFallback = (Fallback)this.mFallbacks.get(i);
          if (paramBoolean)
          {
            if (localFallback.c()) {
  ...
  public JSONObject toJSON()
  {
    try
    {
      ...
      localJSONObject1.put("host", this.host);
      JSONArray localJSONArray = new JSONArray();
      Iterator localIterator = this.mFallbacks.iterator();
      while (localIterator.hasNext()) {
        localJSONArray.put(((Fallback)localIterator.next()).f());
      }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/xiaomi/network/Fallbacks.class

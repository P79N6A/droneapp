  ...
  implements MemoryTrimmable, MemoryCache<K, V>
{
  ...
  private void makeOrphan(Entry<K, V> paramEntry)
  {
    ...
    //   3: monitorenter
    //   4: aload_1
    //   5: invokestatic 143	com/facebook/common/internal/Preconditions:checkNotNull	(Ljava/lang/Object;)Ljava/lang/Object;
    //   8: pop
    //   9: aload_1
    //   10: getfield 156	com/facebook/imagepipeline/cache/CountingMemoryCache$Entry:isOrphan	Z
    //   13: ifne +15 -> 28
    //   16: iload_2
    //   17: invokestatic 150	com/facebook/common/internal/Preconditions:checkState	(Z)V
    //   20: aload_1
    //   21: iconst_1
    //   22: putfield 156	com/facebook/imagepipeline/cache/CountingMemoryCache$Entry:isOrphan	Z
    //   25: aload_0
    //   26: monitorexit
    //   27: return
    //   28: iconst_0
  ...
  private void maybeUpdateCacheParams()
  {
    ...
    //   10: lstore_3
    //   11: invokestatic 100	android/os/SystemClock:elapsedRealtime	()J
    //   14: lstore 5
    //   16: lload_1
    //   17: lload_3
    //   18: ladd
    ...
    //   27: return
    //   28: aload_0
    //   29: invokestatic 100	android/os/SystemClock:elapsedRealtime	()J
    //   32: putfield 102	com/facebook/imagepipeline/cache/CountingMemoryCache:mLastCacheParamsCheck	J
    //   35: aload_0
    //   36: aload_0
    //   37: getfield 84	com/facebook/imagepipeline/cache/CountingMemoryCache:mMemoryCacheParamsSupplier	Lcom/facebook/common/internal/Supplier;
    //   40: invokeinterface 90 1 0
    //   45: checkcast 92	com/facebook/imagepipeline/cache/MemoryCacheParams
    //   48: putfield 94	com/facebook/imagepipeline/cache/CountingMemoryCache:mMemoryCacheParams	Lcom/facebook/imagepipeline/cache/MemoryCacheParams;
    //   51: goto -26 -> 25
    //   54: astore 7
    //   56: aload_0
    //   57: monitorexit
  ...
  private ArrayList<Entry<K, V>> trimExclusivelyOwnedEntries(int paramInt1, int paramInt2)
  {
    ...
    //   68: astore 4
    //   70: aload_0
    //   71: getfield 78	com/facebook/imagepipeline/cache/CountingMemoryCache:mExclusiveEntries	Lcom/facebook/imagepipeline/cache/CountingLruMap;
    //   74: invokevirtual 272	com/facebook/imagepipeline/cache/CountingLruMap:getSizeInBytes	()I
    //   77: iload_2
    //   78: if_icmple -37 -> 41
    //   81: aload_0
    //   82: getfield 78	com/facebook/imagepipeline/cache/CountingMemoryCache:mExclusiveEntries	Lcom/facebook/imagepipeline/cache/CountingLruMap;
    //   85: invokevirtual 276	com/facebook/imagepipeline/cache/CountingLruMap:getFirstKey	()Ljava/lang/Object;
    //   88: astore 4
    //   90: aload_0
    //   91: getfield 78	com/facebook/imagepipeline/cache/CountingMemoryCache:mExclusiveEntries	Lcom/facebook/imagepipeline/cache/CountingLruMap;
    //   94: aload 4
    //   96: invokevirtual 279	com/facebook/imagepipeline/cache/CountingLruMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   99: pop
    //   100: aload 5
    //   102: aload_0
    //   103: getfield 80	com/facebook/imagepipeline/cache/CountingMemoryCache:mCachedEntries	Lcom/facebook/imagepipeline/cache/CountingLruMap;
    //   106: aload 4
    //   108: invokevirtual 279	com/facebook/imagepipeline/cache/CountingLruMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   111: invokevirtual 282	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   114: pop
    //   115: goto -60 -> 55
    //   118: astore 4
    //   120: aload_0
  ...
  public boolean contains(Predicate<K> paramPredicate)
  {
    ...
    //   6: aload_1
    //   7: invokevirtual 311	com/facebook/imagepipeline/cache/CountingLruMap:getMatchingEntries	(Lcom/android/internal/util/Predicate;)Ljava/util/ArrayList;
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/cache/CountingMemoryCache.class

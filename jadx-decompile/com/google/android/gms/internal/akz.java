...
public interface akz extends IInterface {
    ...
    public static abstract class a extends Binder implements akz {

        private static class a implements akz {
            private IBinder a;
        ...
        public static akz a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof akz)) ? new a(iBinder) : (akz) queryLocalInterface;
        }

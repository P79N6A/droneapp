...
final class GeneralAppIdDecoder {
    ...
    private DecodedChar decodeIsoIec646(int i) {
        ...
        switch (extractNumericValueFromBitArray2) {
            ...
            case 233:
                return new DecodedChar(i + 8, l.e);
            case 234:
                return new DecodedChar(i + 8, '%');
            case 235:
                return new DecodedChar(i + 8, '&');
            ...
            case SmileConstants.INT_MARKER_END_OF_STRING /*252*/:
                return new DecodedChar(i + 8, l.c);
            default:
    ...
    private boolean isStillIsoIec646(int i) {
        ...
        if (extractNumericValueFromBitArray < SmileConstants.TOKEN_MISC_BINARY_7BIT || extractNumericValueFromBitArray >= 253) {
            z = false;
        }
        return z;
    }

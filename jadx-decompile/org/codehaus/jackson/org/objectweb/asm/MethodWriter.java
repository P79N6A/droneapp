...
class MethodWriter implements MethodVisitor {
                ...
                while (i < this.r.b) {
                    ...
                    switch (ClassWriter.a[c]) {
                        ...
                        case (byte) 8:
                            ...
                            continue;
                        case (byte) 9:
                            i2 = a(iArr, iArr2, i, a(bArr, i + 1) + i);
                            byteVector.putByte(c);
                            byteVector.putInt(i2);
                            i += 5;
                            continue;
                        case (byte) 13:
                            ...
                            i2 += 4;
                            byteVector.putInt(a(iArr, iArr2, i, a(bArr, i2) + i));
                            c = a(bArr, i2);
                            i3 = i2 + 4;
                            byteVector.putInt(c);
                            i2 = (a(bArr, i3) - c) + 1;
                            ...
                            while (c > 0) {
                                i3 = i2 + 4;
                                byteVector.putInt(a(iArr, iArr2, i, i + a(bArr, i2)));
                                c--;
                                i2 = i3;
                            }
                            break;
    ...
    final int a() {
        ...
        if (this.o != null) {
            ...
            for (i = this.o.length - 1; i >= this.S; i--) {
        ...
        if (this.p != null) {
            ...
            for (i = this.p.length - 1; i >= this.S; i--) {
    ...
    final void a(ByteVector byteVector) {
        ...
        if (this.g != null) {
            byteVector.putShort(this.b.newUTF8(Consts.SIGNATURE)).putInt(2).putShort(this.b.newUTF8(this.g));
        }
        if (this.l != null) {
    ...
    public void visitFrame(int i, int i2, Object[] objArr, int i3, Object[] objArr2) {
        ...
        if (this.M != 0) {
            ...
            switch (i) {
                case 0:
                    this.v.putByte(255).putShort(i8).putShort(i2);
                    for (i8 = 0; i8 < i2; i8++) {
                        a(objArr[i8]);
                    }
                    this.v.putShort(i3);
    ...
    public void visitIincInsn(int i, int i2) {
        ...
        if (i > 255 || i2 > 127 || i2 < -128) {
            this.r.putByte(SmileConstants.MIN_BUFFER_FOR_POSSIBLE_SHORT_STRING).b(132, i).putShort(i2);
        } else {
    ...
    public void visitJumpInsn(int i, Label label) {
        ...
        if ((label.a & 2) == 0 || label.c - this.r.b >= -32768) {
            ...
            if (i == Opcodes.GOTO) {
                ...
                this.r.putByte(i <= Opcodes.IF_ACMPNE ? ((i + 1) ^ 1) - 1 : i ^ 1);
                this.r.putShort(8);
                this.r.putByte(200);
            }
    ...
    public void visitMaxs(int i, int i2) {
        ...
        if (this.M == 0) {
            ...
            for (Handler handler2 = this.B; handler2 != null; handler2 = handler2.f) {
                label2 = handler2.c;
                a2 = handler2.b;
                for (label = handler2.a; label != a2; label = label.i) {
                    Edge edge3 = new Edge();
    ...
    public void visitMethodInsn(int i, String str, String str2, String str3) {
        ...
        Item a = i == Opcodes.INVOKEDYNAMIC ? this.b.a(str2, str3) : this.b.a(str, str2, str3, z);
        int i2 = a.c;
        if (this.P != null) {
            if (this.M == 0) {
                this.P.h.a(i, 0, this.b, a);
                ...
                i2 = (i == Opcodes.INVOKESTATIC || i == Opcodes.INVOKEDYNAMIC) ? ((this.Q - (argumentsAndReturnSizes >> 2)) + (argumentsAndReturnSizes & 3)) + 1 : (this.Q - (argumentsAndReturnSizes >> 2)) + (argumentsAndReturnSizes & 3);
                if (i2 > this.R) {
                    this.R = i2;
                }
                this.Q = i2;

  ...
  protected Consumer<CloseableReference<CloseableImage>> wrapConsumer(Consumer<CloseableReference<CloseableImage>> paramConsumer, final CacheKey paramCacheKey)
  {
    new DelegatingConsumer(paramConsumer)
    {
      ...
      public void onNewResultImpl(CloseableReference<CloseableImage> paramAnonymousCloseableReference, boolean paramAnonymousBoolean)
      {
        ...
        //   0	213	0	this	1
        //   0	213	1	paramAnonymousCloseableReference	CloseableReference<CloseableImage>
        //   0	213	2	paramAnonymousBoolean	boolean
        //   65	143	3	localCloseableReference	CloseableReference
        //   80	106	4	localObject	Object
        //   92	13	5	localQualityInfo	QualityInfo
        // Exception table:
        //   from	to	target	type
        //   70	121	199	finally
        //   121	132	199	finally
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/producers/BitmapMemoryCacheProducer.class

...
public class f extends SQLiteOpenHelper {
    private static final String[] c = new String[]{User.FN_NAME, "TEXT NOT NULL", "appId", "INTEGER NOT NULL", l.PACKAGE_NAME, "TEXT NOT NULL", "create_time", "INTEGER NOT NULL", "type", "TEXT NOT NULL", "center_longtitude", "TEXT", "center_lantitude", "TEXT", "circle_radius", "REAL", "polygon_point", "TEXT", "coordinate_provider", "TEXT NOT NULL", "current_status", "TEXT NOT NULL"};
    private static final String[] d = new String[]{"message_id", "TEXT NOT NULL", "geo_id", "TEXT NOT NULL", "content", "BLOB NOT NULL", AuthActivity.ACTION_KEY, "INTEGER NOT NULL", "deadline", "INTEGER NOT NULL"};
    ...
    private void b(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            for (int i = 0; i < d.length - 1; i += 2) {
                ...
                stringBuilder.append(d[i]).append(" ").append(c[i + 1]);
            }

...
public class d extends b {
    ...
    public boolean b() {
        ...
        intent.putExtra(Constants.PARAM_CLIENT_ID, this.g);
        if (this.i != null && this.i.length > 0) {
            intent.putExtra("scope", TextUtils.join(com.xiaomi.mipush.sdk.Constants.ACCEPT_TIME_SEPARATOR_SP, this.i));
        }
    ...
    public String getAuthorizeUrl() {
        ...
        bundle.putString(AuthorizeActivityBase.KEY_REDIRECT_URI, this.j);
        ...
        bundle.putString(Constants.PARAM_CLIENT_ID, this.g);

...
public class AnimatedDrawable
  extends Drawable
  implements DrawableWithCaches, AnimatableDrawable
{
  ...
  public q.b createAnimatorUpdateListener()
  {
    new q.b()
    {
      public void onAnimationUpdate(q paramAnonymousq)
      {
        AnimatedDrawable.this.setLevel(((Integer)paramAnonymousq.u()).intValue());
      }
    };
  }
  ...
  public q createValueAnimator()
  {
    ...
    q localq = new q();
    localq.a(new int[] { 0, this.mDurationMs });
    localq.d(this.mDurationMs);
    if (i != 0) {}
    for (;;)
    {
      localq.a(i);
      localq.b(1);
      localq.a(new LinearInterpolator());
      localq.a(createAnimatorUpdateListener());
      return localq;
      i = -1;
    }
  }
  
  public q createValueAnimator(int paramInt)
  {
    q localq = createValueAnimator();
    localq.a(Math.max(paramInt / this.mAnimatedDrawableBackend.getDurationMs(), 1));
    return localq;
  }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/animated/base/AnimatedDrawable.class

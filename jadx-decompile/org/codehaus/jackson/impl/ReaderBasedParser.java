            ...
            if (c > l.c) {
                ...
                if (decodeBase64Char < 0) {
                    if (decodeBase64Char != -2) {
                        if (c2 != l.e || base64Variant.usesPadding()) {
                    ...
                    if (decodeBase64Char == -2) {
                        ...
                        if (base64Variant.usesPaddingChar(c3)) {
                            ...
                            throw reportInvalidChar(base64Variant, c3, 3, "expected padding character '" + base64Variant.getPaddingChar() + "'");
                        }
                    }
                }

...
public interface ajj extends IInterface {
    ...
    public static abstract class a extends Binder implements ajj {

        private static class a implements ajj {
            private IBinder a;
        ...
        public static ajj a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ajj)) ? new a(iBinder) : (ajj) queryLocalInterface;
        }

...
public interface alc extends IInterface {
    ...
    public static abstract class a extends Binder implements alc {

        private static class a implements alc {
            private IBinder a;
        ...
        public static alc a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alc)) ? new a(iBinder) : (alc) queryLocalInterface;
        }

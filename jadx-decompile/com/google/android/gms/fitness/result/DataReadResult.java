...
public class DataReadResult extends AbstractSafeParcelable implements m {
    ...
    private boolean b(DataReadResult dataReadResult) {
        return this.c.equals(dataReadResult.c) && c.a(this.b, dataReadResult.b) && c.a(this.d, dataReadResult.d);
    }
    ...
    public DataSet a(DataSource dataSource) {
        for (DataSet dataSet : this.b) {
            if (dataSource.equals(dataSet.b())) {
                return dataSet;
            }
        }
    ...
    public DataSet a(DataType dataType) {
        for (DataSet dataSet : this.b) {
            if (dataType.equals(dataSet.c())) {
                return dataSet;
            }
        }
        return DataSet.a(new a().a(dataType).a(1).a());
    }
    ...
    public int hashCode() {
        return c.a(new Object[]{this.c, this.b, this.d});
    }
    ...
    public String toString() {
        Object obj;
        c.a a = c.a(this).a("status", this.c);
        String str = "dataSets";
        if (this.b.size() > 5) {

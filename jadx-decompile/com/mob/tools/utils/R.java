...
public class R {
    ...
    public static long dateStrToLong(String str) {
        return new SimpleDateFormat(f.b).parse(str, new ParsePosition(0)).getTime();
    }
    ...
    public static long getFileSize(File file) {
        ...
        int i2 = 0;
        while (i < list.length) {
            i2 = (int) (((long) i2) + getFileSize(new File(file, list[i])));
            i++;
        }
        return (long) i2;
    }
    ...
    public static String getImageCachePath(Context context) {
        return getCachePath(context, a.b);
    }
    ...
    public static Uri pathToContentUri(Context context, String str) {
        Cursor query = context.getContentResolver().query(Media.EXTERNAL_CONTENT_URI, new String[]{k._ID}, "_data=? ", new String[]{str}, null);
        if (query != null && query.moveToFirst()) {
            return Uri.withAppendedPath(Uri.parse("content://media/external/images/media"), "" + query.getInt(query.getColumnIndex(k._ID)));

...
public interface alr extends IInterface {
    ...
    public static abstract class a extends Binder implements alr {

        private static class a implements alr {
            private IBinder a;
        ...
        public static alr a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alr)) ? new a(iBinder) : (alr) queryLocalInterface;
        }

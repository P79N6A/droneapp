...
public interface amd extends IInterface {
    ...
    public static abstract class a extends Binder implements amd {

        private static class a implements amd {
            private IBinder a;
        ...
        public static amd a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof amd)) ? new a(iBinder) : (amd) queryLocalInterface;
        }

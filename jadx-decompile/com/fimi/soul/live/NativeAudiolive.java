...
public class NativeAudiolive implements Callback {
    ...
    public void callBack(int i, int i2, int i3) {
        ...
        switch (i) {
            case 4997377:
                i4 = R.string.live_audio_exit;
                break;
            case 4997378:
                i4 = R.string.live_audio_busy_dev;
                break;
            case FM_LIVE_PUSH_EXIT /*5001217*/:
                i4 = R.string.live_push_exit;
                break;
            case 5001218:
                i4 = R.string.live_push_sys_failed;
                break;
            case FM_LIVE_PUSH_FORMAT_ERROR /*5001219*/:
                i4 = R.string.live_push_format_error;
                break;
            case 5001220:
                i4 = R.string.live_push_disconnected;
                break;
            case FM_LIVE_PUSH_NET_BLOCKS /*5001221*/:
                i4 = R.string.live_push_net_blocks;
                break;
            case FM_LIVE_PUSH_RUNNIG /*5001222*/:
                return;
            case FM_LIVE_PUSH_OK /*5001223*/:
                i4 = R.string.live_push_ok;
                break;
            case FM_LIVE_VIDEO_EXIT /*5002753*/:
                i4 = R.string.live_video_exit;
                break;
            case FM_LIVE_VIDEO_SYS_FAILED /*5002754*/:
                i4 = R.string.live_video_sys_failed;
                break;
            case FM_LIVE_VIDEO_FORMAT_ERROR /*5002755*/:
                i4 = R.string.live_video_format_error;
                break;
            case FM_LIVE_VIDEO_DISCONNECTED /*5002756*/:
                i4 = R.string.live_video_disconnected;
                break;
        }

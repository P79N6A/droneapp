...
public final class t {
    ...
    public static String a(Context context) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                str = ajp.b(context).a(context.getPackageName()).toString();
    ...
    private static String a(Context context, String str) {
        synchronized (a) {
            ...
            Object string = c.getString(identifier);
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            case 1:
                if (i.a(resources)) {
                    return resources.getString(R.string.common_google_play_services_install_text_tablet, new Object[]{a});
                }
                return resources.getString(R.string.common_google_play_services_install_text_phone, new Object[]{a});
            case 2:

...
public class RemotePlaybackClient {
    ...
    private void adoptSession(String str) {
        if (str != null) {
            setSessionId(str);
        }
    }
    ...
    private void handleError(Intent intent, ActionCallback actionCallback, String str, Bundle bundle) {
        int i = 0;
        if (bundle != null) {
    ...
    private static String inferMissingResult(String str, String str2) {
        return str2 == null ? str : (str == null || str.equals(str2)) ? str2 : null;
    }
    ...
    private void performItemAction(Intent intent, String str, String str2, Bundle bundle, ItemActionCallback itemActionCallback) {
        ...
        this.mRoute.sendControlRequest(intent, new ControlRequestCallback() {
            ...
            public void onResult(Bundle bundle) {
                if (bundle != null) {
                    String access$100 = RemotePlaybackClient.inferMissingResult(str3, bundle.getString(MediaControlIntent.EXTRA_SESSION_ID));
                    MediaSessionStatus fromBundle = MediaSessionStatus.fromBundle(bundle.getBundle(MediaControlIntent.EXTRA_SESSION_STATUS));
                    String access$1002 = RemotePlaybackClient.inferMissingResult(str4, bundle.getString(MediaControlIntent.EXTRA_ITEM_ID));
                    ...
                    if (!(access$100 == null || access$1002 == null || fromBundle2 == null)) {
                        if (RemotePlaybackClient.DEBUG) {
                            Log.d(RemotePlaybackClient.TAG, "Received result from " + intent2.getAction() + ": data=" + RemotePlaybackClient.bundleToString(bundle) + ", sessionId=" + access$100 + ", sessionStatus=" + fromBundle + ", itemId=" + access$1002 + ", itemStatus=" + fromBundle2);
                        }
                        itemActionCallback2.onResult(bundle, access$100, fromBundle, access$1002, fromBundle2);
                        return;
                    }
                }
    ...
    private void performSessionAction(final Intent intent, final String str, Bundle bundle, final SessionActionCallback sessionActionCallback) {
        ...
        this.mRoute.sendControlRequest(intent, new ControlRequestCallback() {
            ...
            public void onResult(Bundle bundle) {
                if (bundle != null) {
                    String access$100 = RemotePlaybackClient.inferMissingResult(str, bundle.getString(MediaControlIntent.EXTRA_SESSION_ID));
                    MediaSessionStatus fromBundle = MediaSessionStatus.fromBundle(bundle.getBundle(MediaControlIntent.EXTRA_SESSION_STATUS));
                    RemotePlaybackClient.this.adoptSession(access$100);
                    if (access$100 != null) {
                        if (RemotePlaybackClient.DEBUG) {
                            Log.d(RemotePlaybackClient.TAG, "Received result from " + intent.getAction() + ": data=" + RemotePlaybackClient.bundleToString(bundle) + ", sessionId=" + access$100 + ", sessionStatus=" + fromBundle);
                        }
                        try {
                            sessionActionCallback.onResult(bundle, access$100, fromBundle);
                            if (intent.getAction().equals(MediaControlIntent.ACTION_END_SESSION) && access$100.equals(RemotePlaybackClient.this.mSessionId)) {

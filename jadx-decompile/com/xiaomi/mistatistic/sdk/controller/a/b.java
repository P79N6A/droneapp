...
public class b implements e {
    ...
    private void a(h hVar) {
        ...
        String[] split = hVar.e.split(Constants.ACCEPT_TIME_SEPARATOR_SP);
    ...
    private void b(h hVar) {
        ...
        String[] split = hVar.e.trim().split(Constants.ACCEPT_TIME_SEPARATOR_SP);
    ...
    private void c(h hVar) {
        ...
        if (com.google.android.gms.tagmanager.e.b.equals(hVar.d) && TextUtils.isEmpty(hVar.f)) {
        ...
        if (!TextUtils.isEmpty(hVar.f)) {
            jSONObject2.put("params", new JSONObject(hVar.f));
        }
        jSONObject.getJSONArray("values").put(jSONObject2);
    }

    ...
    protected final JsonNode deserializeAny(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        switch (jsonParser.getCurrentToken()) {
            ...
            case VALUE_NUMBER_INT:
                ...
                return (numberType == JsonParser$NumberType.BIG_INTEGER || deserializationContext.isEnabled(Feature.USE_BIG_INTEGER_FOR_INTS)) ? nodeFactory.numberNode(jsonParser.getBigIntegerValue()) : numberType == JsonParser$NumberType.INT ? nodeFactory.numberNode(jsonParser.getIntValue()) : nodeFactory.numberNode(jsonParser.getLongValue());
            case VALUE_NUMBER_FLOAT:
                return (jsonParser.getNumberType() == JsonParser$NumberType.BIG_DECIMAL || deserializationContext.isEnabled(Feature.USE_BIG_DECIMAL_FOR_FLOATS)) ? nodeFactory.numberNode(jsonParser.getDecimalValue()) : nodeFactory.numberNode(jsonParser.getDoubleValue());
            case VALUE_TRUE:

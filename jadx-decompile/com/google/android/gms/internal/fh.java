...
public enum fh {
    ...
    ANY_OF("any_of"),
    APP_NAME(GameAppOperation.QQFAV_DATALINE_APPNAME),
    ...
    PIXEL("pixel"),
    PLACEMENT("placement"),
    PLATFORM(com.tencent.connect.common.Constants.PARAM_PLATFORM),
    POSITION("position"),
    PRICES("prices"),
    PRIORITY("priority"),
    PRODUCT("product"),
    ...
    REVENUE("revenue"),
    SAMPLE_RATE(FimiMediaMeta.IJKM_KEY_SAMPLE_RATE),

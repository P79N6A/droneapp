...
# direct methods
.method private static a(Lorg/json/JSONObject;Landroid/database/Cursor;II)Ljava/util/List;
    .locals 12
    ...
    const-string v4, "voice_to_text_result"
...
.method public static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-class v2, Lcom/baidu/tts/e/a;
    ...
    invoke-static {p0}, Lcom/baidu/tts/e/d;->b(Landroid/content/Context;)I
    ...
    invoke-static {p0, p1}, Lcom/baidu/tts/e/a;->c(Landroid/content/Context;Ljava/lang/String;)Z
    :try_end_1
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {v2, p0}, Lcom/baidu/android/common/net/ProxyHttpClient;-><init>(Landroid/content/Context;)V

    invoke-static {p0, p1}, Lcom/baidu/tts/e/a;->d(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v3, "StatHelper"
    ...
    :try_start_0
    invoke-virtual {v2, v3}, Lcom/baidu/android/common/net/ProxyHttpClient;->execute(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    ...
    const-string v5, "response.getStatusLine().getStatusCode():"
    ...
    :cond_0
    :goto_0
    invoke-virtual {v2}, Lcom/baidu/android/common/net/ProxyHttpClient;->close()V
...
.method private static b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v5}, Lcom/baidu/tts/e/c;->d()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {v5}, Lcom/baidu/tts/e/c;->b()Landroid/database/Cursor;
    ...
    invoke-static {v7, v6, v8, v9}, Lcom/baidu/tts/e/a;->a(Lorg/json/JSONObject;Landroid/database/Cursor;II)Ljava/util/List;

    move-result-object v8

    const-string v9, "StatHelper"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "jsonObj all: "
    ...
    invoke-static {v7}, Lcom/baidu/tts/e/d;->a(Ljava/lang/String;)[B
    ...
    :cond_0
    invoke-static {v7}, Lcom/baidu/tts/e/d;->a([B)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v7}, Lcom/baidu/tts/e/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v5, v8}, Lcom/baidu/tts/e/c;->a(Ljava/util/List;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v8

    invoke-static {p0, v8, v9}, Lcom/baidu/tts/e/d;->a(Landroid/content/Context;J)V
...
.method private static c(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Lcom/baidu/tts/e/a;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/baidu/tts/e/d;->a(Landroid/content/Context;I)V
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_2
    .catch Lorg/apache/http/client/ClientProtocolException; {:try_start_1 .. :try_end_1} :catch_1
...
.method private static d(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/tts/e/d;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/tts/e/d;->e(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/baidu/tts/e/d;->g(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v1, "http://yuyin.baidu.com/voice?osname=voiceopen&action=usereventflow&"
...
.method private static e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "http://uil.cbs.baidu.com/voiceLog/getconfig?"

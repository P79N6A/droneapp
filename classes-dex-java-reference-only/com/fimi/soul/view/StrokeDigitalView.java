...
public class StrokeDigitalView
  extends TextView
{
  private TextView a = null;
  
  public StrokeDigitalView(Context paramContext)
  {
    super(paramContext);
    this.a = new TextView(paramContext);
    ao.b(paramContext.getAssets(), new View[] { this.a, this });
    a();
  }
  
  public StrokeDigitalView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public StrokeDigitalView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/fimi/soul/view/StrokeDigitalView.class

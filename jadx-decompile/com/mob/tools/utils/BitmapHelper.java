...
public class BitmapHelper {
    ...
    public static String downloadBitmap(Context context, final String str) {
        final String cachePath = R.getCachePath(context, a.b);
    ...
    private static String getMime(byte[] bArr) {
        ...
        if (bytesStartWith(bArr, new byte[]{(byte) -119, DroneMap.m, (byte) 78, (byte) 71})) {
            return "png";
        }
    ...
    public static String saveBitmap(Context context, Bitmap bitmap, CompressFormat compressFormat, int i) {
        String cachePath = R.getCachePath(context, a.b);
        String str = ".jpg";
    ...
    public static String saveViewToImage(View view, int i, int i2) {
        ...
        File file = new File(R.getCachePath(view.getContext(), "screenshot"), String.valueOf(System.currentTimeMillis()) + ".jpg");
        OutputStream fileOutputStream = new FileOutputStream(file);

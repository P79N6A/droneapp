...
final class y implements Runnable {
    ...
    public void run() {
        ...
        aeVar.h = new HashMap();
        h.a(aeVar.h, Constants.EXTRA_KEY_APP_VERSION, com.xiaomi.channel.commonutils.android.b.a(this.a, this.a.getPackageName()));
        ...
        h.a(aeVar.h, "push_sdk_vn", "3_2_1");
        h.a(aeVar.h, "push_sdk_vc", Integer.toString(30201));
        h.a(aeVar.h, Constants.EXTRA_KEY_TOKEN, a.d());
        ...
        h.a(aeVar.h, Constants.EXTRA_KEY_ACCEPT_TIME, MiPushClient.getAcceptTime(this.a).replace(Constants.ACCEPT_TIME_SEPARATOR_SP, Constants.ACCEPT_TIME_SEPARATOR_SERVER));
        if (this.b) {
        ...
        u.a(this.a).a(aeVar, a.i, false, null);
    }
}

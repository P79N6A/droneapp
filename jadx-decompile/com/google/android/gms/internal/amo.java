...
public interface amo extends IInterface {
    ...
    public static abstract class a extends Binder implements amo {

        private static class a implements amo {
            private IBinder a;
        ...
        public static amo a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof amo)) ? new a(iBinder) : (amo) queryLocalInterface;
        }

...
public interface ala extends IInterface {
    ...
    public static abstract class a extends Binder implements ala {

        private static class a implements ala {
            private IBinder a;
            ...
            public void a(FileUriResult fileUriResult) {
        ...
        public static ala a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IFileUriCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ala)) ? new a(iBinder) : (ala) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(parcel.readInt() != 0 ? (FileUriResult) FileUriResult.CREATOR.createFromParcel(parcel) : null);
                    return true;
                case 1598968902:
    ...
    void a(FileUriResult fileUriResult);
}

  ...
  extends WakefulBroadcastReceiver
{
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      int i = -1;
      if (str != null) {
        i = FirebaseInstanceIdInternalReceiver.a(paramContext, str, paramIntent);
      }
      if (isOrderedBroadcast()) {
        setResultCode(i);
      }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/google/firebase/iid/FirebaseInstanceIdReceiver.class

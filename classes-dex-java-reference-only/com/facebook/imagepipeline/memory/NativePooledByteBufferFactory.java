  ...
  implements PooledByteBufferFactory
{
  ...
  public NativePooledByteBuffer newByteBuffer(int paramInt)
  {
    ...
    //   5: istore_2
    //   6: iload_2
    //   7: invokestatic 45	com/facebook/common/internal/Preconditions:checkArgument	(Z)V
    //   10: aload_0
    ...
    //   14: iload_1
    //   15: invokevirtual 51	com/facebook/imagepipeline/memory/NativeMemoryChunkPool:get	(I)Ljava/lang/Object;
    //   18: aload_0
    ...
    //   22: invokestatic 57	com/facebook/common/references/CloseableReference:of	(Ljava/lang/Object;Lcom/facebook/common/references/ResourceReleaser;)Lcom/facebook/common/references/CloseableReference;
    //   25: astore_3
    //   26: new 59	com/facebook/imagepipeline/memory/NativePooledByteBuffer
    //   29: dup
    //   30: aload_3
    //   31: iload_1
    //   32: invokespecial 62	com/facebook/imagepipeline/memory/NativePooledByteBuffer:<init>	(Lcom/facebook/common/references/CloseableReference;I)V
    //   35: astore 4
    //   37: aload_3
    //   38: invokevirtual 65	com/facebook/common/references/CloseableReference:close	()V
    //   41: aload 4
    //   43: areturn
    //   44: iconst_0
    //   45: istore_2
    ...
    //   49: astore 4
    //   51: aload_3
    //   52: invokevirtual 65	com/facebook/common/references/CloseableReference:close	()V
    //   55: aload 4
    //   57: athrow
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/memory/NativePooledByteBufferFactory.class

  ...
  private class Vbox
  {
    ...
    final Palette.Swatch getAverageColor()
    {
      ...
      while (m <= this.mUpperIndex)
      {
        ...
        i += ColorCutQuantizer.quantizedBlue(i1) * i2;
        m += 1;
      }
      return new Palette.Swatch(ColorCutQuantizer.approximateToRgb888(Math.round(k / n), Math.round(j / n), Math.round(i / n)), n);
    }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/graphics/ColorCutQuantizer.class

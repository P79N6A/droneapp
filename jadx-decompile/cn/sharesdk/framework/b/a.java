        ...
        try {
            ...
            if (!"none".equals(networkType) && !TextUtils.isEmpty(networkType)) {
                ...
                if (currentTimeMillis - longValue >= 86400000 || i != i2) {
                    HashMap a = this.b.a();
                    this.d.a(a.containsKey(UriUtil.LOCAL_RESOURCE_SCHEME) ? "true".equals(String.valueOf(a.get(UriUtil.LOCAL_RESOURCE_SCHEME))) : true);
                    if (a != null && a.size() > 0) {
        ...
        try {
            ...
            if (!"none".equals(networkType) && !TextUtils.isEmpty(networkType) && this.d.g()) {
                ...
                if (c.containsKey("status") && R.parseInt(String.valueOf(c.get("status"))) == -200) {
                    d.a().d((String) c.get("error"), new Object[0]);
                    return;
                }
                HashMap hashMap;
                ...
                if (c.containsKey("switchs")) {
                    ...
                    if (hashMap != null) {
                        ...
                        String valueOf2 = String.valueOf(hashMap.get(com.google.firebase.a.a.a.q));
                    ...
                    if (hashMap != null) {
                        ...
                        if (hashMap.containsKey("assigns")) {
                            ...
                            for (String str : hashMap.keySet()) {
                                ...
                                Object valueOf7 = String.valueOf(hashMap3.get(j.HOST));
        ...
        try {
            ...
            if (!"none".equals(networkType) && !TextUtils.isEmpty(networkType) && this.d.g()) {
                ...
                for (int i = 0; i < e.size(); i++) {
                    ...
                    if (cVar.b.size() == 1 ? a(cVar.a, false) : a(d(cVar.a), true)) {
                        this.b.a(cVar.b);
                    }
                }
            }

  ...
  implements Closeable
{
  ...
  public List<Long> a(long paramLong)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokevirtual 261	com/google/android/gms/analytics/internal/z:m	()V
    //   7: aload_0
    //   8: invokevirtual 258	com/google/android/gms/analytics/internal/z:D	()V
    //   11: lload_1
    //   12: lconst_0
    //   13: lcmp
    //   14: ifgt +7 -> 21
    //   17: invokestatic 274	java/util/Collections:emptyList	()Ljava/util/List;
    //   20: areturn
    //   21: aload_0
    //   22: invokevirtual 134	com/google/android/gms/analytics/internal/z:F	()Landroid/database/sqlite/SQLiteDatabase;
    //   25: astore 4
    //   27: new 276	java/util/ArrayList
    //   30: dup
    //   31: invokespecial 277	java/util/ArrayList:<init>	()V
    //   34: astore 7
    //   36: ldc_w 279
    //   39: iconst_1
    ...
    //   51: astore 6
    //   53: lload_1
    //   54: invokestatic 284	java/lang/Long:toString	(J)Ljava/lang/String;
    //   57: astore 8
    //   59: aload 4
    //   61: ldc 24
    //   63: iconst_1
    ...
    //   76: aload 6
    //   78: aload 8
    //   80: invokevirtual 288	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore 5
    //   89: aload 5
    ...
    //   117: invokestatic 291	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   120: invokeinterface 294 2 0
    //   125: pop
    //   126: aload 5
    //   128: astore 4
    //   130: aload 5
    //   132: invokeinterface 297 1 0
    //   137: istore_3
    //   138: iload_3
    //   139: ifne -36 -> 103
    //   142: aload 5
    ...
    //   167: ldc_w 299
    //   170: aload 6
    //   172: invokevirtual 113	com/google/android/gms/analytics/internal/z:d	(Ljava/lang/String;Ljava/lang/Object;)V
    //   175: aload 5
    //   177: ifnull -23 -> 154
    //   180: aload 5
  ...
  Map<String, String> a(String paramString)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        return n.a(new URI(paramString), "UTF-8");
  ...
  public void a(x paramx)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        e("Error storing a property", paramx);
      }
    }
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localCursor.moveToFirst())
          {
            ...
            localObject1 = localCursor;
            ((List)localObject5).add(new c(this, a(str1), l, p.f(str2), paramLong, i));
            localObject1 = localCursor;
  ...
  public List<x> d(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 258	com/google/android/gms/analytics/internal/z:D	()V
    //   4: aload_0
    //   5: invokevirtual 261	com/google/android/gms/analytics/internal/z:m	()V
    //   8: aload_0
    //   9: invokevirtual 134	com/google/android/gms/analytics/internal/z:F	()Landroid/database/sqlite/SQLiteDatabase;
    //   12: astore 9
    //   14: aconst_null
    //   15: astore 8
    //   17: aload 8
    //   19: astore 7
    //   21: aload_0
    //   22: invokevirtual 84	com/google/android/gms/analytics/internal/z:q	()Lcom/google/android/gms/analytics/internal/ah;
    //   25: invokevirtual 530	com/google/android/gms/analytics/internal/ah:z	()I
    //   28: istore_3
    //   29: aload 8
    //   31: astore 7
    //   33: aload 9
    ...
    //   80: iconst_0
    //   81: lload_1
    //   82: invokestatic 266	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   85: aastore
    //   86: aconst_null
    //   87: aconst_null
    //   88: aconst_null
    //   89: iload_3
    //   90: invokestatic 534	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   93: invokevirtual 288	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   96: astore 8
    //   98: aload 8
    //   100: astore 7
    //   102: new 276	java/util/ArrayList
    //   105: dup
    //   106: invokespecial 277	java/util/ArrayList:<init>	()V
    //   109: astore 9
    //   111: aload 8
    //   113: astore 7
    //   115: aload 8
    ...
    //   191: aload 8
    //   193: iconst_4
    //   194: invokeinterface 492 2 0
    //   199: invokevirtual 536	com/google/android/gms/analytics/internal/z:b	(Ljava/lang/String;)Ljava/util/Map;
    //   202: astore 12
    //   204: aload 8
    //   206: astore 7
    //   208: aload 10
    //   210: invokestatic 309	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   213: ifne +15 -> 228
    //   216: aload 8
    //   218: astore 7
    //   220: aload 11
    //   222: invokestatic 309	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   225: ifeq +79 -> 304
    //   228: aload 8
    //   230: astore 7
    //   232: aload_0
    ...
    //   236: aload 10
    //   238: aload 11
    //   240: invokevirtual 540	com/google/android/gms/analytics/internal/z:c	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    //   243: aload 8
    //   245: astore 7
    //   247: aload 8
    ...
    //   276: aload_0
    //   277: ldc_w 542
    //   280: invokevirtual 545	com/google/android/gms/analytics/internal/z:t	(Ljava/lang/String;)V
    //   283: aload 8
    //   285: ifnull +10 -> 295
    //   288: aload 8
    ...
    //   306: astore 7
    //   308: aload 9
    //   310: new 412	com/google/android/gms/analytics/internal/x
    //   313: dup
    //   314: lload_1
    //   315: aload 10
    //   317: aload 11
    ...
    //   321: lload 4
    //   323: aload 12
    //   325: invokespecial 548	com/google/android/gms/analytics/internal/x:<init>	(JLjava/lang/String;Ljava/lang/String;ZJLjava/util/Map;)V
    //   328: invokeinterface 294 2 0
    //   333: pop
    //   334: goto -91 -> 243
    //   337: astore 9
    //   339: aload 8
    ...
    //   348: ldc_w 507
    //   351: aload 8
    //   353: invokevirtual 344	com/google/android/gms/analytics/internal/z:e	(Ljava/lang/String;Ljava/lang/Object;)V
    //   356: aload 8
    //   358: athrow
    //   359: astore 8
    //   361: aload 7
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean a(SQLiteDatabase paramSQLiteDatabase, String paramString)
    {
      ...
      //   67: astore_1
      //   68: aload_0
      //   69: getfield 12	com/google/android/gms/analytics/internal/z$a:a	Lcom/google/android/gms/analytics/internal/z;
      //   72: ldc 96
      //   74: aload_2
      //   75: aload 5
      //   77: invokevirtual 100	com/google/android/gms/analytics/internal/z:c	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
      //   80: aload 4
      //   82: ifnull +10 -> 92
      //   85: aload 4
    ...
    public SQLiteDatabase getWritableDatabase()
    {
      ...
      {
        z.a(z.this).a();
        z.this.u("Opening the database failed, dropping the table and recreating it");
        Object localObject = z.b(z.this);
        z.this.o().getDatabasePath((String)localObject).delete();
        try
        {
        ...
        {
          z.this.e("Failed to open freshly created database", localSQLiteException2);
    ...
    {
      an.a(paramSQLiteDatabase.getPath());
    }
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            paramSQLiteDatabase.execSQL(z.G());
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/google/android/gms/analytics/internal/z.class

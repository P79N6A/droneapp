...
public class k
{
  ...
  private k(Context paramContext, String paramString, Bundle paramBundle)
  {
  ...
  private void a()
  {
    ...
    try
    {
      ...
      localObject2 = ((Method)localObject2).invoke(null, new Object[] { this.f });
      Intent localIntent = new Intent("com.parse.bolts.measurement_event");
      localIntent.putExtra("event_name", this.g);
      localIntent.putExtra("event_args", this.h);
  ...
  static void a(Context paramContext, String paramString, Intent paramIntent, Map<String, String> paramMap)
  {
    ...
    for (paramIntent = a(paramContext, paramString, (Bundle)localObject2, paramIntent);; paramIntent = (Intent)localObject1)
    {
      ...
      new k(paramContext, paramString, paramIntent).a();
      return;
    }
  }
}
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/a/k.class

...
public interface xu extends IInterface {
    ...
    public static abstract class a extends Binder implements xu {

        private static class a implements xu {
            private IBinder a;
            ...
            public uu d() {
                ...
                try {
                    ...
                    obtain2.readException();
                    uu a = com.google.android.gms.internal.uu.a.a(obtain2.readStrongBinder());
                    return a;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static xu a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof xu)) ? new a(iBinder) : (xu) queryLocalInterface;
        }

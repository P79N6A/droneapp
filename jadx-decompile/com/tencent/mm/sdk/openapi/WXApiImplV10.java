...
final class WXApiImplV10 implements IWXAPI {
    ...
    public final boolean isWXAppInstalled() {
        boolean z = false;
        try {
            PackageInfo packageInfo = this.R.getPackageManager().getPackageInfo(PluginIntent.APP_PACKAGE_PATTERN, 64);
            if (packageInfo != null) {
    ...
    public final boolean openWXApp() {
        if (isWXAppInstalled()) {
            try {
                this.R.startActivity(this.R.getPackageManager().getLaunchIntentForPackage(PluginIntent.APP_PACKAGE_PATTERN));
                return true;
            } catch (Exception e) {
    ...
    public final boolean registerApp(String str) {
        if (a(PluginIntent.APP_PACKAGE_PATTERN)) {
            ...
            MMessage.send(this.R, PluginIntent.APP_PACKAGE_PATTERN, ConstantsAPI.ACTION_HANDLE_APP_REGISTER, "weixin://registerapp?appid=" + this.S);
            return true;
        }
    ...
    public final void unregisterApp() {
        if (!a(PluginIntent.APP_PACKAGE_PATTERN)) {
            ...
            MMessage.send(this.R, PluginIntent.APP_PACKAGE_PATTERN, ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER, "weixin://unregisterapp?appid=" + this.S);
        }
    }
}

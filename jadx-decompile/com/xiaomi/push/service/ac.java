...
public class ac {
    ...
    private static Notification a(Notification notification) {
        Object a = a.a(notification, "extraNotification");
        if (a != null) {
            a.a(a, "setCustomizedIcon", new Object[]{Boolean.valueOf(true)});
        }
        return notification;
    }
        ...
        if (!(str2 == null || obj == null)) {
            ...
            if (bitmap != null) {
                ...
                if (s != null && VERSION.SDK_INT >= 24) {
                    ...
                    a.a(builder, "setGroup", new Object[]{str});
                    a.a(builder, "setGroupSummary", new Object[]{Boolean.valueOf(parseBoolean)});
                }
                ...
                if (currentTimeMillis - a > NotificationOptions.a) {
                    a = currentTimeMillis;
    ...
    public static b a(Context context, ab abVar, byte[] bArr) {
        b bVar = new b();
        if (com.xiaomi.channel.commonutils.android.b.d(context, a(abVar)) == com.xiaomi.channel.commonutils.android.b.a.c) {
            b.a("Do not notify because user block " + a(abVar) + "‘s notification");
            return bVar;
        } else if (ay.a(context, abVar)) {
            b.a("Do not notify because user block " + ay.a(abVar) + "‘s notification");
            return bVar;
        } else {
    ...
    private static void a(Notification notification, int i) {
        Object a = a.a(notification, "extraNotification");
        if (a != null) {
            a.a(a, "setMessageCount", new Object[]{Integer.valueOf(i)});
        }
    }
    ...
    private static RemoteViews b(Context context, ab abVar, byte[] bArr) {
        ...
        try {
            ...
            try {
                ...
                if (jSONObject2.has(com.fimi.soul.utils.a.b.a.i)) {
                    jSONObject2 = jSONObject2.getJSONObject(com.fimi.soul.utils.a.b.a.i);

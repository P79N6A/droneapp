...
public class RuntimeCollector {
        ...
        for (HashMap<String, String>[] hashMapArr2 : hashMapArr) {
            ...
            while (length >= 0) {
                if (hashMapArr2[length] != null) {
                    ...
                    hashMap.put(User.FN_NAME, hashMapArr2[length].get(User.FN_NAME));
    ...
    private void a() {
        Thread anonymousClass1 = new Thread(this) {
            ...
            public void run() {
                e.a(new File(R.getCacheRoot(this.a.c), "comm/locks/.rc_lock"), new Runnable(this) {
...
*/
                ...
                if (split != null && split.length >= 10) {
                    ...
                    if (split[split.length - 2].matches(a) && !"top".equals(obj)) {
                        ...
                        if (strArr != null) {
                            ...
                            hashMap2.put(User.FN_NAME, strArr[0]);
            ...
            private HashMap<String, String[]> e() {
                ...
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    hashMap.put((String) ((HashMap) it.next()).get("pkg"), new String[]{(String) r0.get(User.FN_NAME), (String) ((HashMap) it.next()).get("version")});
                }
                return hashMap;
            }

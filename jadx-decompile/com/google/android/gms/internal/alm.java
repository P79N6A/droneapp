...
public interface alm extends IInterface {
    ...
    public static abstract class a extends Binder implements alm {

        private static class a implements alm {
            private IBinder a;
        ...
        public static alm a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IReadRawCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alm)) ? new a(iBinder) : (alm) queryLocalInterface;
        }

  ...
  extends BaseAdapter
{
  ...
  public d(Context paramContext, List<FirmwareInfo> paramList)
  {
    this.b = paramContext;
    this.a = paramList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramViewGroup.b.setText(((FirmwareInfo)this.a.get(paramInt)).getSysName() + ":" + ((FirmwareInfo)this.a.get(paramInt)).getUpdcontents());
      return localView;
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/fimi/soul/b/d.class

...
public abstract class MiPushClient
{
  ...
  public static void initialize(Context paramContext, String paramString1, String paramString2, MiPushClientCallback paramMiPushClientCallback)
  {
    ...
    for (;;)
    {
        ...
        if ((!bool) && (a.a(sContext).a(paramString1, paramString2)) && (!a.a(sContext).n())) {
          if (1 == PushMessageHelper.getPushMode(paramContext))
          {
            ...
            if (a.a(sContext).a())
            {
              ...
              paramString1.h.put("push_sdk_vn", "3_2_1");
              paramString1.h.put("push_sdk_vc", Integer.toString(30201));
      ...
      paramMiPushClientCallback.g("3_2_1");
      paramMiPushClientCallback.a(30201);
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/xiaomi/mipush/sdk/MiPushClient.class

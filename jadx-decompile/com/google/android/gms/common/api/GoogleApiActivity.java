...
public class GoogleApiActivity extends Activity implements OnCancelListener {
    ...
    private void a() {
        ...
        if (pendingIntent == null && num == null) {
            ...
            b.a().b(this, num.intValue(), 2, this);
            this.a = 1;
        }
    }

    private void a(int i, aic com_google_android_gms_internal_aic) {
        switch (i) {
            case -1:
                com_google_android_gms_internal_aic.b();
                return;
            case 0:
                com_google_android_gms_internal_aic.b(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
                return;
            default:
                return;
        }

...
public final class GifFormatChecker {
    ...
    private static final byte[] FRAME_HEADER_END_2 = new byte[]{(byte) 0, SmileConstants.TOKEN_LITERAL_NULL};
    private static final int FRAME_HEADER_SIZE = 10;
    private static final byte[] FRAME_HEADER_START = new byte[]{(byte) 0, SmileConstants.TOKEN_LITERAL_NULL, (byte) -7, (byte) 4};

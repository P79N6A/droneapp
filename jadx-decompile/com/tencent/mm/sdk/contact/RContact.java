...
public class RContact extends MAutoDBItem {
    ...
    public static String formatDisplayNick(String str) {
        return str == null ? null : str.toLowerCase().endsWith("@t.qq.com") ? "@" + str.replace("@t.qq.com", "") : str.toLowerCase().endsWith("@qqim") ? str.replace("@qqim", "") : str;
    }
    ...
    public int calculateShowHead() {
        ...
        return (i < 97 || i > 122) ? (i < 65 || i > 90) ? Opcodes.LSHR : i : (char) (i - 32);
    }

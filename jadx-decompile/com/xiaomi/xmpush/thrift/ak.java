...
public class ak implements Serializable, Cloneable, org.a.b.a<ak, a> {
    ...
    public int b(ak akVar) {
        ...
        if (a()) {
            compareTo = org.a.b.b.a(this.a, akVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (b()) {
            compareTo = org.a.b.b.a(this.b, akVar.b);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (c()) {
            compareTo = org.a.b.b.a(this.c, akVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.a.b.b.a(this.d, akVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.a.b.b.a(this.e, akVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (f()) {
            compareTo = org.a.b.b.a(this.f, akVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.a.b.b.a(this.g, akVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }

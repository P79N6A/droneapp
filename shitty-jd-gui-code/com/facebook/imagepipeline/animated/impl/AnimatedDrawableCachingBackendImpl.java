  ...
  implements AnimatedDrawableCachingBackend
{
  ...
  private void cancelFuturesOutsideOfRange(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      if (i < this.mDecodesInFlight.size())
      {
        ...
        {
          l locall = (l)this.mDecodesInFlight.valueAt(i);
  ...
  private void doPrefetch(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        final l locall = (l)this.mDecodesInFlight.get(j);
        if ((!bool) && (locall == null))
        {
          locall = l.a(new Callable()
          {
            public Object call()
            {
          ...
          this.mDecodesInFlight.put(j, locall);
          locall.a(new j()
          {
            public Object then(l<Object> paramAnonymousl)
            {
              AnimatedDrawableCachingBackendImpl.this.onFutureFinished(locall, j);
              return null;
            }
          });
        }
  ...
  private void maybeCacheRenderedBitmap(int paramInt, CloseableReference<Bitmap> paramCloseableReference)
  {
    ...
    //   24: iload_1
    //   25: invokevirtual 350	android/support/v4/util/SparseArrayCompat:indexOfKey	(I)I
    //   28: istore_3
    //   29: iload_3
    //   30: iflt +25 -> 55
    //   33: aload_0
    ...
    //   59: iload_1
    //   60: aload_2
    //   61: invokevirtual 321	com/facebook/common/references/CloseableReference:clone	()Lcom/facebook/common/references/CloseableReference;
  ...
  private void onFutureFinished(l<?> paraml, int paramInt)
  {
    try
    {
      int i = this.mDecodesInFlight.indexOfKey(paramInt);
      if ((i >= 0) && ((l)this.mDecodesInFlight.valueAt(i) == paraml))
      {
        this.mDecodesInFlight.removeAt(i);
        if (paraml.f() != null) {
          FLog.v(TAG, paraml.f(), "Failed to render frame %d", new Object[] { Integer.valueOf(paramInt) });
        }
      }
      return;
    }
  ...
  @VisibleForTesting
  Map<Integer, l<?>> getDecodesInFlight()
  {
    try
    {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl.class

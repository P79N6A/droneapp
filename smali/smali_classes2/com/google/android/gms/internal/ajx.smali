...
# static fields
.field public static final a:Lcom/google/android/gms/drive/metadata/internal/e$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/google/android/gms/internal/ajx$1;

    invoke-direct {v0}, Lcom/google/android/gms/internal/ajx$1;-><init>()V

    sput-object v0, Lcom/google/android/gms/internal/ajx;->a:Lcom/google/android/gms/drive/metadata/internal/e$a;
...
.method static synthetic a(Lcom/google/android/gms/common/data/DataHolder;)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/ajx;->d(Lcom/google/android/gms/common/data/DataHolder;)V

    return-void
.end method

.method private static b(Lcom/google/android/gms/common/data/DataHolder;)Landroid/support/v4/util/LongSparseArray;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/common/data/DataHolder;->a(I)I

    move-result v0

    invoke-virtual {p0, v2, v1, v0}, Lcom/google/android/gms/common/data/DataHolder;->a(Ljava/lang/String;II)J

    move-result-wide v8

    invoke-virtual {p0, v3, v1, v0}, Lcom/google/android/gms/common/data/DataHolder;->c(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {p0, v4, v1, v0}, Lcom/google/android/gms/common/data/DataHolder;->b(Ljava/lang/String;II)I

    move-result v10

    invoke-virtual {p0, v5, v1, v0}, Lcom/google/android/gms/common/data/DataHolder;->c(Ljava/lang/String;II)Ljava/lang/String;
    ...
    check-cast v0, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$a;
    ...
    :cond_0
    invoke-virtual {v0, v11}, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$a;->a(Lcom/google/android/gms/drive/metadata/internal/CustomProperty;)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$a;
...
.method private static c(Lcom/google/android/gms/common/data/DataHolder;)V
    .locals 8
    ...
    :cond_0
    :try_start_1
    invoke-static {v0}, Lcom/google/android/gms/internal/ajx;->b(Lcom/google/android/gms/common/data/DataHolder;)Landroid/support/v4/util/LongSparseArray;
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/gms/common/data/DataHolder;->a(I)I

    move-result v5

    invoke-virtual {p0, v1, v2, v5}, Lcom/google/android/gms/common/data/DataHolder;->a(Ljava/lang/String;II)J
    ...
    check-cast v1, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$a;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$a;->a()Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
...
.method private static d(Lcom/google/android/gms/common/data/DataHolder;)V
    .locals 2
...
.method protected synthetic c(Lcom/google/android/gms/common/data/DataHolder;II)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/gms/internal/ajx;->d(Lcom/google/android/gms/common/data/DataHolder;II)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
...
.method protected d(Lcom/google/android/gms/common/data/DataHolder;II)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
    .locals 3
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/ajx;->c(Lcom/google/android/gms/common/data/DataHolder;)V

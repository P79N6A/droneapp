...
public class o {
    ...
    public static synchronized n a(Context context) {
        ...
        synchronized (o.class) {
            if (a != null) {
                ...
                String string6 = sharedPreferences.getString(l.PACKAGE_NAME, null);
    ...
    public static synchronized n a(Context context, String str, String str2, String str3) {
        ...
        synchronized (o.class) {
            ...
            treeMap.put(com.mi.live.openlivesdk.b.g, str6);
            treeMap.put("model", Build.MODEL);
            treeMap.put(Constants.EXTRA_KEY_IMEI_MD5, d.a(e.c(context)));
            treeMap.put(j.ac, VERSION.RELEASE + Constants.ACCEPT_TIME_SEPARATOR_SERVER + VERSION.INCREMENTAL);
            int b = e.b();
            if (b >= 0) {
            ...
            if (!TextUtils.isEmpty(str7)) {
                ...
                if (jSONObject.getInt(XiaomiOAuthConstants.EXTRA_CODE_2) == 0) {
                    ...
                    nVar = new n(jSONObject2.getString("userId") + "@xiaomi.com/an" + d.a(6), jSONObject2.getString(Constants.EXTRA_KEY_TOKEN), jSONObject2.getString("ssecurity"), str4, str5, str6, a.c());
                    a(context, nVar);
                    a = nVar;
                } else {
                    r.a(context, jSONObject.getInt(XiaomiOAuthConstants.EXTRA_CODE_2), jSONObject.optString("description"));
                    b.a(str7);
                }
            }
        }
    ...
    public static void a(Context context, n nVar) {
        ...
        edit.putString(l.PACKAGE_NAME, nVar.f);

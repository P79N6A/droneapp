...
public abstract class MiPushClient {
    ...
    private static void scheduleGeoFenceRepeatJobs() {
        if (com.xiaomi.push.service.h.b(sContext)) {
            f.a(sContext).a(new d(sContext), ah.a(sContext).a(com.xiaomi.xmpush.thrift.e.UploadWIFIGeoLocFrequency.a(), (int) IMediaPlayer.MEDIA_INFO_TIMED_TEXT_ERROR));
        }
    }

    private static void scheduleOcVersionCheckJob() {
        f.a(sContext).a(new o(sContext), ah.a(sContext).a(com.xiaomi.xmpush.thrift.e.OcVersionCheckFrequency.a(), (int) Strategy.g), 5);
    }
    ...
    private static boolean shouldPullNotification(Context context) {
        return Math.abs(System.currentTimeMillis() - context.getSharedPreferences(PREF_EXTRA, 0).getLong("last_pull_notification", -1)) > MiStatInterface.MIN_UPLOAD_INTERVAL;
    }

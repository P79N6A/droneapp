...
public interface anh extends IInterface {
    ...
    public static abstract class a extends Binder implements anh {
        ...
        public static anh a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof anh)) ? new a(iBinder) : (anh) queryLocalInterface;
        }

...
public class ImagePipelineConfig {
    ...
    private static DiskCacheConfig getDefaultMainDiskCacheConfig(final Context context) {
        return DiskCacheConfig.newBuilder().setBaseDirectoryPathSupplier(new Supplier<File>() {
            public File get() {
                return context.getApplicationContext().getCacheDir();
            }
        }).setBaseDirectoryName("image_cache").setMaxCacheSize(41943040).setMaxCacheSizeOnLowDiskSpace(10485760).setMaxCacheSizeOnVeryLowDiskSpace(2097152).build();
    }

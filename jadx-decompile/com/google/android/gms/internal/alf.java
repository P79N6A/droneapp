...
public interface alf extends IInterface {
    ...
    public static abstract class a extends Binder implements alf {

        private static class a implements alf {
            private IBinder a;
            ...
            public void a(GetFileUriRequest getFileUriRequest) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.fitness.internal.IGoogleFitHistoryApi");
        ...
        public static alf a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof alf)) ? new a(iBinder) : (alf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 10:
                    ...
                    return true;
                case 11:
                    DataUpdateListenerUnregistrationRequest dataUpdateListenerUnregistrationRequest;
                    parcel.enforceInterface("com.google.android.gms.fitness.internal.IGoogleFitHistoryApi");
                    if (parcel.readInt() != 0) {
                ...
                case 12:
                    parcel.enforceInterface("com.google.android.gms.fitness.internal.IGoogleFitHistoryApi");
                    if (parcel.readInt() != 0) {
                        getFileUriRequest = (GetFileUriRequest) GetFileUriRequest.CREATOR.createFromParcel(parcel);
                    }
                    a(getFileUriRequest);
                    parcel2.writeNoException();
                    return true;
    ...
    void a(GetFileUriRequest getFileUriRequest);

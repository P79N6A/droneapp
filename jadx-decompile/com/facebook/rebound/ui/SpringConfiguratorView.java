...
public class SpringConfiguratorView extends FrameLayout {
    ...
    private View generateHierarchy(Context context) {
        ...
        frameLayout.setLayoutParams(Util.createLayoutParams(-1, Util.dpToPx(b.i, resources)));
        ...
        ViewGroup.LayoutParams createLayoutParams2 = Util.createLayoutParams(Util.dpToPx(b.c, resources), Util.dpToPx(40.0f, resources));

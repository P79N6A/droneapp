...
public class d {
    ...
    public String toString() {
        ...
        if (this.z == 4 && this.w != null) {
            ...
            while (it.hasNext()) {
                c cVar = (c) it.next();
                stringBuilder.append(cVar.a).append(Constants.ACCEPT_TIME_SEPARATOR_SP).append(cVar.b).append(Constants.ACCEPT_TIME_SEPARATOR_SP).append(cVar.c).append(Constants.ACCEPT_TIME_SEPARATOR_SP).append(cVar.d).append(Constants.ACCEPT_TIME_SEPARATOR_SP).append(cVar.e).append(Constants.ACCEPT_TIME_SEPARATOR_SP).append(cVar.f).append("\n");
            }
        }
        if (this.z == 7) {
            if (this.h == 0) {

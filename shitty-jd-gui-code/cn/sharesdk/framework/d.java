      ...
      for (;;)
      {
        ...
        ((AlertDialog.Builder)localObject).setPositiveButton(str1, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            ...
            try
            {
              paramAnonymousDialogInterface = paramSslErrorHandler.getClass().getMethod("proceed", new Class[0]);
              paramAnonymousDialogInterface.setAccessible(true);
              paramAnonymousDialogInterface.invoke(paramSslErrorHandler, new Object[0]);
              return;
            }
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/cn/sharesdk/framework/d.class

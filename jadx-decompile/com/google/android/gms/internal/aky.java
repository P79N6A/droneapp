...
public interface aky extends IInterface {
    ...
    public static abstract class a extends Binder implements aky {

        private static class a implements aky {
            private IBinder a;
        ...
        public static aky a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDataSourcesCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof aky)) ? new a(iBinder) : (aky) queryLocalInterface;
        }

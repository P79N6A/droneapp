...
# virtual methods
.method public createAnimatorUpdateListener()Lcom/a/a/q$b;
    .locals 1
...
.method public createValueAnimator()Lcom/a/a/q;
    .locals 5
    ...
    invoke-virtual {v1, v2}, Lcom/a/a/q;->a([I)V

    iget v2, p0, Lcom/facebook/imagepipeline/animated/base/AnimatedDrawable;->mDurationMs:I

    int-to-long v2, v2

    invoke-virtual {v1, v2, v3}, Lcom/a/a/q;->d(J)Lcom/a/a/q;

    if-eqz v0, :cond_0

    :goto_0
    invoke-virtual {v1, v0}, Lcom/a/a/q;->a(I)V
    ...
    invoke-virtual {v1, v0}, Lcom/a/a/q;->a(Landroid/view/animation/Interpolator;)V

    invoke-virtual {p0}, Lcom/facebook/imagepipeline/animated/base/AnimatedDrawable;->createAnimatorUpdateListener()Lcom/a/a/q$b;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/a/a/q;->a(Lcom/a/a/q$b;)V
...
.method public createValueAnimator(I)Lcom/a/a/q;
    .locals 3

    invoke-virtual {p0}, Lcom/facebook/imagepipeline/animated/base/AnimatedDrawable;->createValueAnimator()Lcom/a/a/q;
    ...
    invoke-virtual {v0, v1}, Lcom/a/a/q;->a(I)V

...
public class JaxbAnnotationIntrospector extends AnnotationIntrospector implements Versioned {
        ...
        if (xmlElementWrapper != null) {
            ...
            if (xmlAttribute != null) {
                ...
                if (xmlElement != null) {
                    ...
                    return ((XmlValue) annotatedElement.getAnnotation(XmlValue.class)) != null ? "value" : null;
                }
            }
        }
    }
    ...
    protected <A extends Annotation> A findAnnotation(Class<A> cls, Annotated annotated, boolean z, boolean z2, boolean z3) {
        ...
        if (annotated instanceof AnnotatedMethod) {
            ...
            if (findPropertyDescriptor != null) {
                annotation = new AnnotatedProperty(findPropertyDescriptor).getAnnotation(cls);
                if (annotation != null) {
                    return annotation;
                }
            }
    ...
    protected String findJaxbSpecifiedPropertyName(PropertyDescriptor propertyDescriptor) {
        return findJaxbPropertyName(new AnnotatedProperty(propertyDescriptor), propertyDescriptor.getPropertyType(), propertyDescriptor.getName());
    }

...
abstract class ag<T extends af>
  extends s
{
  a<T> a;
  
  public ag(v paramv, a<T> parama)
  {
    super(paramv);
    this.a = parama;
  }
  ...
  public T a(int paramInt)
  {
    try
    {
      af localaf = a(k().c().getResources().getXml(paramInt));
      return localaf;
    }
  ...
  public static abstract interface a<U extends af>
  {
...
/* Location:              /Users/andi/Downloads/dex2jar-2.0/classes-dex2jar.jar!/com/google/android/gms/analytics/internal/ag.class
